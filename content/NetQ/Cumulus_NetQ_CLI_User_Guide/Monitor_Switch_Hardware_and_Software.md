...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-MonitorSwitchandHostHardwareInformation" class="section section-1">
...
{{% notice info %}} The keyword values for the model, disk, arch, name,
transport, and type keywords are specific to your deployment. For
example, if you have devices with CPU architectures of only one type,
say Intel x86, then that is the only option available for the cpu-arch
keyword value. If you have multiple CPU architectures, say you also have
ARMv7, then that would also be an option for you. {{% /notice %}}
...
attributes of all switches and all hosts in your
network.

<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewaSummaryofYourNetworkInventory" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewInformationabouttheASIConallSwitches" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewInformationabouttheMotherboardinaSwitch" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewInformationabouttheCPUonaSwitch" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewInformationabouttheDiskonaSwitch" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewMemoryInformationforaSwitch" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewaSummaryofAllHardwareInformationforaSwitch" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-MonitorSwitchSoftwareInformation" class="section section-1">
...
netq [] show inventory brief [json]
netq [] show inventory license [cumulus] [around ] [json]
netq [] show inventory license [cumulus] changes [between  and ] [json]
netq [] show inventory os [version |name ] [json]netq [] show events [level info | level warning | level error | level debug] type os [version |name ] [vrf ] changes [between  and ]
 
netq [] show events [level info | level warning | level error | level debug] type license [<???>] [vrf ] changes [between  and ]
...
{{% notice info %}} The keyword values for the name keyword is specific
to your deployment. For example, if you have devices with only one type
of OS, say Cumulus Linux, then that is the only option available for the
os-name keyword value. If you have multiple OSs running, say you also
have Ubuntu, then that would also be an option for you. {{% /notice %}}
...
numeric value and the unit of measure: w: week(s) d: day(s) h: hour(s)
m: minute(s) s: second(s) now For time ranges, the \<text-time\> is the
most recent time and the \<text-endtime\> is the oldest time. The values
do not have to have the same unit of measure. {{% /notice
%}}
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewOSInformationforaSwitch" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewLicenseInformationforaSwitch" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewSummaryofOperatingSystemonaSwitch" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ValidateNetQAgentsareRunning" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-MonitorSoftwareServices" class="section section-1">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewAllServicesonAllDevices" class="section section-2">
...
use the *hostname* variable to the
command.

</div>

<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewInformationaboutaGivenServiceonAllDevices" class="section section-2">
...
<div id="src-8365481_MonitorSwitchHardwareandSoftware-ViewEventsRelatedtoaGivenService" class="section section-2">
...
Alarm
Events](https://docs.cumulusnetworks.com/display/NETQ20DRAFT/Monitor+Alarm+Events)
and [Monitor Informational
Events](https://docs.cumulusnetworks.com/display/NETQ20DRAFT/Monitor+Informational+Events).
