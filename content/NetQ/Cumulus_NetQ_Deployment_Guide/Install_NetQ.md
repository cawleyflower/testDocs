...
included here:
  ...
  - [Install NetQ Agent on a Cumulus Linux
    Switch](/old/#src-10456317_InstallNetQ-AgentCL)

  - [Install NetQ Agent on an Ubuntu
    Server](/old/#src-10456317_InstallNetQ-AgentUbuntu)

  - [Install NetQ Agent on a Red Hat or CentOS
    Server](/old/#src-10456317_InstallNetQ-AgentRHC)
...
relevant additional instructions after the basic configuration steps:
  ...
  - [Configuring the Agent to Use a
    VRF](/old/#src-10456317_InstallNetQ-AgentVRF)

  - [Configuring the Agent to Communicate over a Specific
    Port](/old/#src-10456317_InstallNetQ-port)
...
3.  Link the node to the NetQ Platform you configured above.  
    ...
    VRF](/old/#src-10456317_InstallNetQ-AgentVRF). If you intend to
    specify a port for communication, skip to [Configure the Agent to
    Communicate over a Specific
    Port](/old/#src-10456317_InstallNetQ-port).In this example, the IP
    address for the agent and cli servers is *192.168.1.254*.
