...
| {{%imgOld 2 %}} | Total number of switches with the CLAG service enabled during the designated time period |
| {{%imgOld 3 %}} | Total number of CLAG-related alarms received during the designated time period           |
...
| {{%imgOld 6 %}}           | Total number of switches with the CLAG service enabled during the designated time period              |
| {{%imgOld 7 %}}           | Total number of CLAG-related alarms received during the designated time period                        |
| {{%imgOld 8 %}}           | Total number of sessions with an inactive backup IP address                                           |
| {{%imgOld 9 %}}           | Total number of bonds with only a single connection                                                   |
...
<tr class="even">
<td><p>{{%imgOld 48 %}}</p></td>
<td><p>Device identifiers (hostname, IP address, or MAC address) for host and peer in session. Arrow points from the host to the peer. Click on</p>
<p>{{%imgOld 49 %}}</p>
...
The large CLAG Session card contains one tab.
...
To view all events, o pen the full screen CLAG Session card, and click
the **All Events** tab.
