...
Host](/old/https://docs.cumulusnetworks.com/display/ROH/Routing+on+the+Host)
provides the ability to run
[OSPF](/old/Open_Shortest_Path_First_-_OSPF.html) or
[BGP](/old/Border_Gateway_Protocol_-_BGP.html) directly on server hosts.
This can enable a network architecture known as *anycast*, where many
servers can provide the same service without needing layer 2 extensions
or load balancer appliances.
...
[equal cost
multipath](/old/Equal_Cost_Multipath_Load_Sharing_-_Hardware_ECMP.html)
...
advertising the 172.16.255.66/32 anycast IP
address.

![/images/download/attachments/8363010/anycast\_1.png](/images/download/attachments/8363010/anycast_1.png)
...
port 53). Each flow has a unique source port generated by the
client.

![/images/download/attachments/8363010/anycast\_2.png](/images/download/attachments/8363010/anycast_2.png)
...
![/images/download/attachments/8363010/anycast\_3.png](/images/download/attachments/8363010/anycast_3.png)
...
[Resilient
hashing](/old/Equal_Cost_Multipath_Load_Sharing_-_Hardware_ECMP.html#src-8362929_EqualCostMultipathLoadSharing-HardwareECMP-resilient_hashing)
...
uses leaf02 to reach
server02.

![/images/download/attachments/8363010/anycast\_4.png](/images/download/attachments/8363010/anycast_4.png)

As leaf03 is brought back into service, the hashing function on spine02
changes, impacting the blue dotted
flow:

![/images/download/attachments/8363010/anycast\_5.png](/images/download/attachments/8363010/anycast_5.png)
...
![/images/download/attachments/8363010/anycast\_6.png](/images/download/attachments/8363010/anycast_6.png)
...
the red dashed line has rehashed to
leaf03:

![/images/download/attachments/8363010/anycast\_7.png](/images/download/attachments/8363010/anycast_7.png)
...
since they do not currently flow through
leaf02:

![/images/download/attachments/8363010/anycast\_8.png](/images/download/attachments/8363010/anycast_8.png)
...
chapter](/old/Equal_Cost_Multipath_Load_Sharing_-_Hardware_ECMP.html).
