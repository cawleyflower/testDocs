...
which has been modified to provide the PAE (port access
entity).

![images/download/attachments/8363046/802.1X.png](images/download/attachments/8363046/802.1X.png)
...
## Supported Features and Limitations
  ...
  - You can configure 802.1X interfaces for bridges in both [VLAN-aware
    mode](VLAN-aware_Bridge_Mode.html) and [traditional
    mode](Traditional_Bridge_Mode.html) using the following features:
...
In Cumulus Linux 3.7.4, you can configure up to four DAS clients to be
