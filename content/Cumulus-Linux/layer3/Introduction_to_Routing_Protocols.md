...
-   [Routing
    Protocols](#IntroductiontoRoutingProtocols-RoutingProtocols)
-   [Configure Routing
    Protocols](#IntroductiontoRoutingProtocols-ConfigureRoutingProtocols)
-   [Protocol Tuning](#IntroductiontoRoutingProtocols-ProtocolTuning)
...
Protocol](Open_Shortest_Path_First_-_OSPF)) or IS-IS, complete local
information (links and attached address prefixes) about a node is
