...
-   [Supported
    Features](#PrescriptiveTopologyManager-PTM-SupportedFeatures)
-   [Configure
    PTM](#PrescriptiveTopologyManager-PTM-configuringConfigurePTM)
-   [Basic Topology
    Example](#PrescriptiveTopologyManager-PTM-exampleBasicTopologyExample)
-   [ptmd Scripts](#PrescriptiveTopologyManager-PTM-advancedptmdScripts)
-   [Configuration
    Parameters](#PrescriptiveTopologyManager-PTM-ConfigurationParameters)
    -   [Host-only
        Parameters](#PrescriptiveTopologyManager-PTM-Host-onlyParameters)
    -   [Global
        Parameters](#PrescriptiveTopologyManager-PTM-GlobalParameters)
    -   [Per-port
        Parameters](#PrescriptiveTopologyManager-PTM-Per-portParameters)
    -   [Templates](#PrescriptiveTopologyManager-PTM-Templates)
    -   [Supported BFD and LLDP
        Parameters](#PrescriptiveTopologyManager-PTM-SupportedBFDandLLDPParameters)
-   [Bidirectional Forwarding Detection
    (BFD)](#PrescriptiveTopologyManager-PTM-bfdBidirectionalForwardingDetection(BFD))
-   [Check Link State with
    FRRouting](#PrescriptiveTopologyManager-PTM-frrCheckLinkStatewithFRRouting)
-   [ptmd Service
    Commands](#PrescriptiveTopologyManager-PTM-ptmd_commandsptmdServiceCommands)
-   [ptmctl Commands](#PrescriptiveTopologyManager-PTM-ptmctlCommands)
    -   [ptmctl
        Examples](#PrescriptiveTopologyManager-PTM-ptmctlExamples)
    -   [ptmctl Error
        Outputs](#PrescriptiveTopologyManager-PTM-ptmctlErrorOutputs)
-   [Caveats and
    Errata](#PrescriptiveTopologyManager-PTM-CaveatsandErrata)
-   [Related
    Information](#PrescriptiveTopologyManager-PTM-RelatedInformation)
...
-   Forwarding path failure detection using [Bidirectional Forwarding
    ...
    Detection - BFD](Bidirectional_Forwarding_Detection_-_BFD) chapter
    and read `man ptmd(8)`.
...
-   User configuration via a `topology.dot` file; [see
    below](#PrescriptiveTopologyManager-PTM-configuring).
...
![](attachments/8363021/8363020.png){width="500"}
...
below](#PrescriptiveTopologyManager-PTM-ptmd_commands).
...
topic](Bidirectional_Forwarding_Detection_-_BFD).
...
If you encounter errors with the `topology.dot` file, you can
use `dot` (included in the Graphviz package) to validate the syntax of
the topology file.
...
[2s2l2s\_DOT.png](attachments/8363021/8363020.png) (image/png)  
