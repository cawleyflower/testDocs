...
statistics, and other running configuration information. See
...
-   [Configure LLDP](#LinkLayerDiscoveryProtocol-ConfigureLLDP)
-   [Example lldpcli
    Commands](#LinkLayerDiscoveryProtocol-ExamplelldpcliCommands)
-   [Enable the SNMP Subagent in
    LLDP](#LinkLayerDiscoveryProtocol-snmpEnabletheSNMPSubagentinLLDP)
-   [Caveats and Errata](#LinkLayerDiscoveryProtocol-CaveatsandErrata)
-   [Related
    Information](#LinkLayerDiscoveryProtocol-RelatedInformation)
...
You can disable LLDP on a single port by editing
the `/etc/default/lldpd` file. This file specifies the default options
to present to the `lldpd` service when it starts. The following example
