...
challenges in determining the destination *virtual tunnel
endpoints* (VTEPs) for any given VXLAN. At scale, various solutions,
including [Lightweight Network
Virtualization](Lightweight_Network_Virtualization_Overview) (LNV),
controller-based options like [Midokura
MidoNet](Integrating_Hardware_VTEPs_with_Midokura_MidoNet_and_OpenStack) or [VMware
NSX](Integrating_Hardware_VTEPs_with_VMware_NSX-MH) and even new
standards like [EVPN](Ethernet_Virtual_Private_Network_-_EVPN) are
attempts to address these complexities, however do retain their own
complexities.
...
-   [Requirements](#StaticVXLANTunnels-Requirements)
-   [Example Configuration](#StaticVXLANTunnels-ExampleConfiguration)
-   [Configure Static VXLAN
    Tunnels](#StaticVXLANTunnels-ConfigureStaticVXLANTunnels)
-   [Verify the
    Configuration](#StaticVXLANTunnels-VerifytheConfiguration)

## Requirements

Cumulus Networks supports static VXLAN tunnels only on switches in
the [Cumulus Linux HCL](http://cumulusnetworks.com/hcl/) using the
Broadcom Tomahawk, Trident II+ and Trident II ASICs, as well as
the Mellanox Spectrum ASIC.
...
![](attachments/8362793/8362792.png){height="250"}
...
<th>Node</th>
<th>NCLU Commands</th>
<th>/etc/network/interfaces Configuration</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<pre class="text" data-syntaxhighlighter-params="brush: text; gutter: false; theme: Confluence" data-theme="Confluence" style="brush: text; gutter: false; theme: Confluence"><code>cumulus@leaf02:~$ net add loopback lo ip address 10.0.0.12/32
...
<td><div class="code panel pdl" style="border-width: 1px;">
<div class="codeContent panelContent pdl">
<pre class="text" data-syntaxhighlighter-params="brush: text; gutter: false; theme: Confluence" data-theme="Confluence" style="brush: text; gutter: false; theme: Confluence"><code># The loopback network interface
auto lo
iface lo inet loopback
...
iface vni-10
    ...
    vxlan-remoteip 10.0.0.13
    vxlan-remoteip 10.0.0.14</code></pre>
</div>
</div></td>
</tr>
<tr class="even">
...
<td><div class="code panel pdl" style="border-width: 1px;">
<div class="codeContent panelContent pdl">
<pre class="text" data-syntaxhighlighter-params="brush: text; gutter: false; theme: Confluence" data-theme="Confluence" style="brush: text; gutter: false; theme: Confluence"><code>cumulus@leaf03:~$ net add loopback lo ip address 10.0.0.13/32
...
<td><div class="code panel pdl" style="border-width: 1px;">
<div class="codeContent panelContent pdl">
<pre class="text" data-syntaxhighlighter-params="brush: text; gutter: false; theme: Confluence" data-theme="Confluence" style="brush: text; gutter: false; theme: Confluence"><code>cumulus@leaf04:~$ net add loopback lo ip address 10.0.0.14/32
...
iface vni-10
    ...
    vxlan-remoteip 10.0.0.11
    vxlan-remoteip 10.0.0.12
    vxlan-remoteip 10.0.0.13</code></pre>
</div>
</div></td>
</tr>
</tbody>
...
![](images/icons/bullet_blue.gif){width="8" height="8"} [static vxlan
tunnels.png](attachments/8362793/8362792.png) (image/png)  
