...
core (the underlay). The initial definition of VXLAN ([RFC
7348](https://tools.ietf.org/html/rfc7348)) did not include any control
...
such as [Lightweight Network Virtualization
(LNV)](https://docs.cumulusnetworks.com/display/DOCS/Lightweight+Network+Virtualization+-+LNV+Overview) in Cumulus
Linux.

You cannot use EVPN and LNV at the same time.

Ethernet Virtual Private Network (EVPN) is a standards-based control
plane for [VXLAN](Network_Virtualization) defined in [RFC
7432](https://tools.ietf.org/html/rfc7432) and [draft-ietf-bess-evpn-overlay](https://datatracker.ietf.org/doc/draft-ietf-bess-evpn-overlay/) that
...
-   Support for dual-attached hosts via [VXLAN active-active
    mode](LNV_VXLAN_Active-Active_Mode). MAC synchronization between the
    peer switches is done
    using [MLAG](Multi-Chassis_Link_Aggregation_-_MLAG).
...
-   ECMP support for overlay networks on RIOT-capable Broadcom switches
    ...
    Spectrum-A1 and Tomahawk switches.
...
You can provision and manage EVPN
using [NCLU](Network_Command_Line_Utility_-_NCLU).
...
limitations, see [VXLAN Routing](VXLAN_Routing).
...
-   [Basic EVPN
    Configuration](#EthernetVirtualPrivateNetwork-EVPN-BasicEVPNConfiguration)
    -   [Enable EVPN between BGP
        Neighbors](#EthernetVirtualPrivateNetwork-EVPN-EnableEVPNbetweenBGPNeighbors)
    -   [Advertise All
        VNIs](#EthernetVirtualPrivateNetwork-EVPN-allvnisAdvertiseAllVNIs)
    -   [Auto-derivation of RDs and
        RTs](#EthernetVirtualPrivateNetwork-EVPN-RD-auto-derivationAuto-derivationofRDsandRTs)
    -   [User-defined RDs and
        RTs](#EthernetVirtualPrivateNetwork-EVPN-RD-user-definedUser-definedRDsandRTs)
    -   [Enable EVPN in an iBGP Environment with an OSPF
        Underlay](#EthernetVirtualPrivateNetwork-EVPN-EnableEVPNinaniBGPEnvironmentwithanOSPFUnderlay)
    -   [Disable Data Plane MAC Learning over VXLAN
        Tunnels](#EthernetVirtualPrivateNetwork-EVPN-DisableDataPlaneMACLearningoverVXLANTunnels)
    -   [BUM Traffic](#EthernetVirtualPrivateNetwork-EVPN-BUMTraffic)
-   [ARP and ND
    Suppression](#EthernetVirtualPrivateNetwork-EVPN-arpARPandNDSuppression)
    -   [UFT Profiles Other than the
        Default](#EthernetVirtualPrivateNetwork-EVPN-UFTProfilesOtherthantheDefault)
    -   [Support for EVPN Neighbor Discovery (ND) Extended
        Community](#EthernetVirtualPrivateNetwork-EVPN-ND_extended_communitySupportforEVPNNeighborDiscovery(ND)ExtendedCommunity)
-   [EVPN and VXLAN Active-active
    Mode](#EthernetVirtualPrivateNetwork-EVPN-EVPNandVXLANActive-activeMode)
    -   [Active-active VTEP Anycast IP
        Behavior](#EthernetVirtualPrivateNetwork-EVPN-Active-activeVTEPAnycastIPBehavior)
    -   [Failure Scenario
        Behaviors](#EthernetVirtualPrivateNetwork-EVPN-FailureScenarioBehaviors)
-   [Inter-subnet
    Routing](#EthernetVirtualPrivateNetwork-EVPN-Inter-subnetRouting)
    -   [Centralized
        Routing](#EthernetVirtualPrivateNetwork-EVPN-centralizedCentralizedRouting)
    -   [Asymmetric
        Routing](#EthernetVirtualPrivateNetwork-EVPN-asymmetricAsymmetricRouting)
    -   [Symmetric
        Routing](#EthernetVirtualPrivateNetwork-EVPN-symmetricSymmetricRouting)
-   [Prefix-based Routing — EVPN Type-5
    Routes](#EthernetVirtualPrivateNetwork-EVPN-PBR_type5Prefix-basedRouting—EVPNType-5Routes)
    -   [Configure the Switch to Install EVPN Type-5
        Routes](#EthernetVirtualPrivateNetwork-EVPN-ConfiguretheSwitchtoInstallEVPNType-5Routes)
    -   [Announce EVPN Type-5
        Routes](#EthernetVirtualPrivateNetwork-EVPN-AnnounceEVPNType-5Routes)
    -   [EVPN Type-5 Routing with Asymmetric
        Routing](#EthernetVirtualPrivateNetwork-EVPN-EVPNType-5RoutingwithAsymmetricRouting)
    -   [Control Which RIB Routes Are Injected into
        EVPN](#EthernetVirtualPrivateNetwork-EVPN-ControlWhichRIBRoutesAreInjectedintoEVPN)
    -   [Originate Default EVPN Type-5
        Routes](#EthernetVirtualPrivateNetwork-EVPN-OriginateDefaultEVPNType-5Routes)
-   [EVPN
    Enhancements](#EthernetVirtualPrivateNetwork-EVPN-EVPNEnhancements)
    -   [Static (Sticky) MAC
        Addresses](#EthernetVirtualPrivateNetwork-EVPN-Static(Sticky)MACAddresses)
    -   [Filter EVPN Routes Based on
        Type](#EthernetVirtualPrivateNetwork-EVPN-filter_evpn_route_typeFilterEVPNRoutesBasedonType)
    -   [Extended
        Mobility](#EthernetVirtualPrivateNetwork-EVPN-MAC-mobilityExtendedMobility)
    -   [Duplicate Address
        Detection](#EthernetVirtualPrivateNetwork-EVPN-dadDuplicateAddressDetection)
-   [EVPN Operational
    Commands](#EthernetVirtualPrivateNetwork-EVPN-EVPNOperationalCommands)
    -   [General Linux Commands Related to
        EVPN](#EthernetVirtualPrivateNetwork-EVPN-GeneralLinuxCommandsRelatedtoEVPN)
    -   [General BGP Operational Commands Relevant to
        EVPN](#EthernetVirtualPrivateNetwork-EVPN-GeneralBGPOperationalCommandsRelevanttoEVPN)
    -   [Display EVPN address-family
        Peers](#EthernetVirtualPrivateNetwork-EVPN-DisplayEVPNaddress-familyPeers)
    -   [Display VNIs in
        EVPN](#EthernetVirtualPrivateNetwork-EVPN-DisplayVNIsinEVPN)
    -   [Examine Local and Remote MAC Addresses for a VNI in
        EVPN](#EthernetVirtualPrivateNetwork-EVPN-ExamineLocalandRemoteMACAddressesforaVNIinEVPN)
    -   [Examine Local and Remote Neighbors for a VNI in
        EVPN](#EthernetVirtualPrivateNetwork-EVPN-ExamineLocalandRemoteNeighborsforaVNIinEVPN)
    -   [Examine Remote Router MACs in
        EVPN](#EthernetVirtualPrivateNetwork-EVPN-ExamineRemoteRouterMACsinEVPN)
    -   [Examine Gateway Next Hops in
        EVPN](#EthernetVirtualPrivateNetwork-EVPN-ExamineGatewayNextHopsinEVPN)
    -   [Display the VRF Routing Table in
        FRR](#EthernetVirtualPrivateNetwork-EVPN-DisplaytheVRFRoutingTableinFRR)
    -   [Display the Global BGP EVPN Routing
        Table](#EthernetVirtualPrivateNetwork-EVPN-DisplaytheGlobalBGPEVPNRoutingTable)
    -   [Display a Specific EVPN
        Route](#EthernetVirtualPrivateNetwork-EVPN-DisplayaSpecificEVPNRoute)
    -   [Display the per-VNI EVPN Routing
        Table](#EthernetVirtualPrivateNetwork-EVPN-Displaytheper-VNIEVPNRoutingTable)
    -   [Display the per-VRF BGP Routing
        Table](#EthernetVirtualPrivateNetwork-EVPN-Displaytheper-VRFBGPRoutingTable)
    -   [Examine MAC
        Moves](#EthernetVirtualPrivateNetwork-EVPN-ExamineMACMoves)
    -   [Examine Sticky MAC
        Addresses](#EthernetVirtualPrivateNetwork-EVPN-ExamineStickyMACAddresses)
-   [Troubleshooting](#EthernetVirtualPrivateNetwork-EVPN-Troubleshooting)
-   [Caveats](#EthernetVirtualPrivateNetwork-EVPN-caveatsCaveats)
-   [Example
    Configurations](#EthernetVirtualPrivateNetwork-EVPN-ExampleConfigurations)
    -   [Basic Clos (4x2) for
        Bridging](#EthernetVirtualPrivateNetwork-EVPN-BasicClos(4x2)forBridging)
    -   [Clos Configuration with MLAG and Centralized
        Routing](#EthernetVirtualPrivateNetwork-EVPN-ClosConfigurationwithMLAGandCentralizedRouting)
    -   [Clos Configuration with MLAG and EVPN Asymetric
        Routing](#EthernetVirtualPrivateNetwork-EVPN-ClosConfigurationwithMLAGandEVPNAsymetricRouting)
    -   [Basic Clos Configuration with EVPN Symmetric
        Routing](#EthernetVirtualPrivateNetwork-EVPN-BasicClosConfigurationwithEVPNSymmetricRouting)
...
You enable EVPN between [BGP](Border_Gateway_Protocol_-_BGP) neighbors
...
needed in [FRRouting](FRRouting_Overview). Additional configuration
options for specific scenarios are described later on in this chapter.
...
`bgp l2vpn evpn` is recommended to standardize the BGP address-family
configuration to the AFI/SAFI format.

The above commands create the following configuration snippet in
...
below](#EthernetVirtualPrivateNetwork-EVPN-allvnis).
...
the `vni` option within NCLU to configure the switch:
...
`address-family l2vpn evpn` in BGP.
...
EVPN can be deployed with an [OSPF](Open_Shortest_Path_First_-_OSPF) or
...
For a bridge in [traditional mode](Traditional_Bridge_Mode), you must
edit the bridge configuration in the `/etc/network/interfaces` file
using a text editor: 
...
Replication
(HER)](Lightweight-Network-Virtualization-Overview_8362706.html#LightweightNetworkVirtualizationOverview-head-end).
...
To configure ARP or ND suppression,
use [NCLU](Network_Command_Line_Utility_-_NCLU). Here is an example
...
active-active mode](LNV_VXLAN_Active-Active_Mode). Both switches in
the [MLAG](Multi-Chassis_Link_Aggregation_-_MLAG) pair establish EVPN
...
-   The `clagd-vxlan-anycast-ip` parameter is under the [loopback
    stanza](LNV-VXLAN-Active-Active-Mode_8362725.html#LNVVXLANActive-ActiveMode-anycast) on
    both peers.
-   The anycast address is advertised to the routed fabric from both
    peers.
-   The [VNIs](LNV-VXLAN-Active-Active-Mode_8362725.html#LNVVXLANActive-ActiveMode-example) are
    configured identically on both peers.
    However, `vxlan-local-`tunnelip must be sourced from unique loopback stanza IP address
    of the switch.
-   The [peerlink](LNV-VXLAN-Active-Active-Mode_8362725.html#LNVVXLANActive-ActiveMode-example) must
...
(`clagd-vxlan-anycast-ip`) under the loopback
interface. `clagd` dynamically adds and removes this address as the
loopback interface address as follows:
...
forwarding](Virtual_Routing_and_Forwarding_-_VRF)). A VRF instance is
...
When configuring [VXLAN routing](VXLAN_Routing), Cumulus Networks
...
The above commands create the following snippet in
the `/etc/network/interfaces` file:
...
These commands create the following snippet in
the `/etc/network/interfaces` file:
...
RTs](#EthernetVirtualPrivateNetwork-EVPN-RD-auto-derivation) and
[User-defined RDs and
RTs](#EthernetVirtualPrivateNetwork-EVPN-RD-user-defined), above.
...
1.  Enable advertisement of EVPN prefix (type-5) routes. Refer
    to [Prefix-based Routing — EVPN Type-5
    Routes](#EthernetVirtualPrivateNetwork-EVPN-PBR_type5), below.
2.  Ensure that the routes corresponding to the connected subnets are
    ...
    the `network` command or redistributing them using
...
An earlier version of this chapter referred to the
`advertise-subnet` command. That command is deprecated and should not be
used.
...
see [caveats](#EthernetVirtualPrivateNetwork-EVPN-caveats), below for a
...
![](attachments/8362732/8366123.png)

#### Configure Duplicate Address Detection

To change the threshold for MAC and IP address moves, run
the `net add bgp l2vpn evpn dup-addr-detection max-moves <number-of-events> time <duration>` 
command. You can specify `max-moves` to be between 2 and 1000
and `time` to be between 2 and 1800 seconds.
...
Detection](#EthernetVirtualPrivateNetwork-EVPN-disableDAD) below. 
...
address *permanently* (until you intervene) or for a *defined amount of
time*, after which it is cleared automatically. 
...
frozen *permanently,* issue the [clear
command](#EthernetVirtualPrivateNetwork-EVPN-clearDuplicateAddress) on
...
command](#EthernetVirtualPrivateNetwork-EVPN-clearDuplicateAddress)).

If you issue the [clear
command](#EthernetVirtualPrivateNetwork-EVPN-clearDuplicateAddress) or
...
out, or you intervene and clear the faulty MAC and ARP table entries.
...
run
the `net clear evpn dup-addr vni <vni_id> ip <mac/ip address>` command. The
following example command clears IP address 10.0.0.9 for VNI 101.
...
command](#EthernetVirtualPrivateNetwork-EVPN-clearDuplicateAddress) on
both the MLAG primary and secondary switch.
...
After the duplicate MAC address is cleared,
the `net show evpn mac vni <vni_id> mac <mac_addr>` command shows:
...
To display information for a duplicate IP address, run
the `net show evpn arp-cache vni <vni_id> ip <ip_addr> `command. The
...
or for all VNIs, run
the `net show evpn mac vni <vni-id|all> duplicate` command. The
...
or for all VNIs, run
the `net show evpn arp-cache vni <vni-id|all> duplicate` command. The
...
To show configured duplicate address detection parameters, run
the `net show evpn` command:
...
You can view the MAC forwarding database on the switch by running
the `net show bridge macs` command:
...
the `net show bgp l2vpn evpn summary `command. The following sample
...
When symmetric routing is deployed, run
the `net show evpn rmac vni <vni> `command to examine the router MACs
...
Run the  `net show evpn rmac vni all `command to examine router MACs for
all layer 3 VNIs.

### Examine Gateway Next Hops in EVPN

When symmetric routing is deployed, you can run
the `net show evpn next-hops vni <vni>` command to examine the gateway
...
Run the net show evpn next-hops vni all command to examine gateway next
hops for all layer 3 VNIs.  
...
To drill down on a specific route for more information, run
the `net show bgp l2vpn evpn route rd <rd-value>` command. This command
...
corresponding to each and the associated router MAC address.
...
-   If the remote host is dual attached, the next hop for the EVPN route
    ...
    [MLAG](Multi-Chassis_Link_Aggregation_-_MLAG) pair, when MLAG is
    active.
...
to **import** them into. For example, a spine switch maintains the
...
the `net show bgp l2vpn evpn route vni <vni>` command:
...
the `net show bgp l2vpn evpn route vni all` command.
...
the `net show bgp vrf <vrf-name> ipv4 unicast` command or
the `net show bgp vrf <vrf-name> ipv6 unicast` command.
...
You can identify static or *sticky* MACs in EVPN by the presence
of `MM:0, sticky MAC` in the Extended Community line of the output
from `net show bgp l2vpn evpn route vni <vni> mac <mac>:`
...
-   In a [VXLAN
    active-active](LNV_VXLAN_Active-Active_Mode) configuration, ARPs are
    sometimes *not* suppressed even if ARP suppression is enabled. This
    ...
    This has no impact on forwarding.
...
![](attachments/8362732/8362735.png){height="400"}
...
![](attachments/8362732/8362734.png){height="400"}
...
![](attachments/8362732/8362733.png){height="400"}
...
![](attachments/8362732/8362731.png){height="400"}
...
[evpn.png](attachments/8362732/8362745.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[symmetric-routing.png](attachments/8362732/8362744.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"} [Clos and EVPN
symmetric routing.png](attachments/8362732/8362743.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[EVPEN\_MLAG\_Config.png](attachments/8362732/8362742.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[asymmetric-evpn@2000x.png](attachments/8362732/8362741.png)
(image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[Asymmetric-EVPN.png](attachments/8362732/8362740.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"} [Centralized
– EVPN.png](attachments/8362732/8362739.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"} [Symmetric –
EVPN.png](attachments/8362732/8362738.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[basic\_CLOS\_EVPN\_fix.png](attachments/8362732/8362737.png)
(image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[EVPN-BasicCLOS-2000.png](attachments/8362732/8362736.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[EVPN-BasicCLOS.png](attachments/8362732/8362735.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[EVPN\_Centralized.png](attachments/8362732/8362734.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[EVPN\_Asymmetric.png](attachments/8362732/8362733.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[EVPN\_Symmetric.png](attachments/8362732/8362731.png) (image/png)  
![](images/icons/bullet_blue.gif){width="8" height="8"}
[DAD\_example.png](attachments/8362732/8366123.png) (image/png)  
