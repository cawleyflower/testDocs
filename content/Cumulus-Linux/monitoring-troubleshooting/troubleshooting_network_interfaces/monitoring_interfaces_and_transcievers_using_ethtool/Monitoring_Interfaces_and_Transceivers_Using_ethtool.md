...
-   [Monitor Interface Status Using
    ethtool](#MonitoringInterfacesandTransceiversUsingethtool-MonitorInterfaceStatusUsingethtool)
-   [View and Clear Interface
    Counters](#MonitoringInterfacesandTransceiversUsingethtool-ViewandClearInterfaceCounters)
-   [Monitor Switch Port SFP/QSFP Hardware Information Using
    ethtool](#MonitoringInterfacesandTransceiversUsingethtool-MonitorSwitchPortSFP/QSFPHardwareInformationUsingethtool)
...
this information when you run `cl-netstat`, `ifconfig`, or
`cat /proc/net/dev`. You can also use `cl-netstat` to save or clear this
information:
