...
The [`cl-support`](Understanding_the_cl-support_Output_File) script
...
<tr class="odd">
<td>/etc/nologin</td>
<td><p><code>nologin </code>prevents unprivileged users from logging into the system.</p></td>
</tr>
<tr class="even">
<td>/etc/alternatives</td>
<td><p><code>update-alternatives</code> creates, removes, maintains and displays information about the symbolic links comprising the Debian alternatives system.</p></td>
</tr>
</tbody>
</table>
