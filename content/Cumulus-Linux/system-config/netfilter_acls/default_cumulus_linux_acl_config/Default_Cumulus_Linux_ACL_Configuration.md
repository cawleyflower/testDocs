...
![](images/icons/grey_arrow_down.png){.expand-control-image}Default ACL
Configuration
...
<ul>
<li>UDP/BFD Echo</li>
<li>UDP/BFD Control</li>
<li>UDP BFD Multihop Control</li>
<li>OSPF</li>
<li>TCP/BGP (spt dpt 179)</li>
<li>TCP/MLAG (spt dpt 5342)</li>
</ul></td>
</tr>
<tr class="odd">
<td><p>Set Class: 6</p>
...
<td><p>Protocol:</p>
<ul>
<li>Multicast Listener Query (MLD)</li>
<li>Multicast Listener Report (MLD)</li>
<li>Multicast Listener Done (MLD)</li>
<li>Multicast Listener Report V2</li>
</ul></td>
</tr>
<tr class="even">
<td><p>Set class: 2</p>
...
<td><p>Protocol:</p>
<ul>
<li>ipv6-icmp router-solicitation</li>
</ul></td>
</tr>
<tr class="odd">
<td><p>Set class: 2</p>
...
<td><p>Protocol:</p>
<ul>
<li>ipv6-icmp router-advertisement POLICE</li>
</ul></td>
</tr>
<tr class="even">
<td><p>Set class: 2</p>
...
<td><p>Protocol:</p>
<ul>
<li>ipv6-icmp neighbour-solicitation</li>
<li>ipv6-icmp neighbour-advertisement</li>
</ul></td>
</tr>
<tr class="odd">
<td><p>Set class: 2</p>
