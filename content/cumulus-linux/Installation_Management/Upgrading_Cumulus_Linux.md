...
| --------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `/etc/network/`             | Network configuration files, most notably `/etc/network/interfaces` and `/etc/network/interfaces.d/` | [Switch Port Attributes](/version/cumulus-linux/Layer_1_and_Switch_Ports/Interface_Configuration_and_Management/Switch_Port_Attributes)              | N/A                                                                                                                          |
...
| `/etc/frr/`                 | Routing application (responsible for BGP and OSPF)                                                   | [FRRouting Overview](/version/cumulus-linux/Layer_3/FRRouting_Overview/)                                                                             | N/A                                                                                                                          |
...
| `/etc/cumulus/acl/*`        | Netfilter configuration                                                                              | [Netfilter - ACLs](/version/cumulus-linux/System_Configuration/Netfilter_-_ACLs/)                                                                    | N/A                                                                                                                          |
...
| `/etc/cumulus/switchd.conf` | Switchd configuration                                                                                | [Configuring switchd](/version/cumulus-linux/System_Configuration/Configuring_switchd)                                                               | N/A; please read the guide on switchd configuration                                                                          |
...
<td><p><a href="/version/cumulus-linux/Layer_2/Link_Layer_Discovery_Protocol/">Link Layer Discovery Protocol</a></p></td>
...
<td><p><a href="/version/cumulus-linux/System_Configuration/Authentication_Authorization_and_Accounting/TACACS_Plus">TACACS Plus</a></p></td>
<td><p>N/A</p></td>
</tr>
<tr class="even">
<td><p><code>/etc/ssh/</code></p></td>
<td><p>SSH configuration files</p></td>
<td><p><a href="/version/cumulus-linux/System_Configuration/Authentication_Authorization_and_Accounting/SSH_for_Remote_Access">SSH for Remote Access</a></p></td>
...
<td><p><a href="/version/cumulus-linux/System_Configuration/Authentication_Authorization_and_Accounting/Using_sudo_to_Delegate_Privileges">Using sudo to Delegate Privileges</a></p></td>
<td></td>
</tr>
</tbody>
</table>
...
virtualization](/version/cumulus-linux/Network_Virtualization/),
including [VMware
NSX-V](/version/cumulus-linux/Network_Virtualization/Virtualization_Integrations/Integrating_Hardware_VTEPs_with_VMware_NSX-V)
or [Midokura
...
7.  If you were originally running Cumulus Linux 3.0.0 through 3.3.2,
    ...
    FRRouting](/version/cumulus-linux/Layer_3/FRRouting_Overview/Upgrading_from_Quagga_to_FRRouting).
...
## <span>Related Information</span>
  ...
  - [Zero Touch Provisioning -
    ZTP](/version/cumulus-linux/Installation_Management/Zero_Touch_Provisioning_-_ZTP)
