...
pageID: 8363046
aliases:
 - /old/Cumulus_Linux/802.1X_Interfaces.html
...
[RADIUS](/old/Cumulus_Linux/RADIUS_AAA.html) (Remote Authentication Dial
In User Service, defined by
...
## Supported Features and Limitations
  ...
  - You can configure 802.1X interfaces for bridges in both [VLAN-aware
    mode](/old/Cumulus_Linux/VLAN-aware_Bridge_Mode.html) and
  ...
  - Cumulus Linux 3.7.4 and later includes support for Multi Domain
    ...
    authorization:
      ...
      - MDA is enabled by default; however, you need to assign a tagged
        ...
        VLAN-aware
        Bridge](/old/Cumulus_Linux/#src-8363046_id-802.1XInterfaces-Configure802.1XInterfacesforaVLAN-awareBridge)).
      ...
      - The MAB timer is not required (see [Configure MAC Authentication
        Bypass](/old/Cumulus_Linux/#src-8363046_id-802.1XInterfaces-ConfigureMACAuthenticationBypass)).
...
Server](/old/Cumulus_Linux/#src-8363046_id-802.1XInterfaces-server_config),
above for details.
