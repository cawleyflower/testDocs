...
version: '3.6'
aliases:
 - /display/undefined/Policy-based+Routing
...
Mode](https://docs.cumulusnetworks.com/display/DOCS/Netfilter+-+ACLs#Netfilter-ACLs-nonatomicNonatomicUpdateModevs.AtomicUpdateMode).
