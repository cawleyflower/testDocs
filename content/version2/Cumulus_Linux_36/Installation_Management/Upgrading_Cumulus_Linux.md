...
version: '3.6'
aliases:
 - /display/undefined/Upgrading+Cumulus_Linux
...
| ------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| /etc/network/             | Network configuration files, most notably `/etc/network/interfaces` and `/etc/network/interfaces.d/` | [Switch Port Attributes](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)                                             | N/A                                                                                                                          |
...
| /etc/frr/                 | Routing application (responsible for BGP and OSPF)                                                   | [FRRouting Overview](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)                                                 | N/A                                                                                                                          |
| /etc/hostname             | Configuration file for the hostname of the switch                                                    | [Quick Start Guide\#ConfiguringtheHostnameandTimeZone](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)               | [wiki.debian.org/HowTo/ChangeHostname](https://wiki.debian.org/HowTo/ChangeHostname)                                         |
| /etc/cumulus/acl/\*       | Netfilter configuration                                                                              | [Netfilter - ACLs](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)                                                   | N/A                                                                                                                          |
| /etc/cumulus/ports.conf   | Breakout cable configuration file                                                                    | [Switch Port Attributes\#ConfiguringBreakoutPorts](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)                   | N/A; please read the guide on breakout cables                                                                                |
| /etc/cumulus/switchd.conf | Switchd configuration                                                                                | [Configuring switchd](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)                                                | N/A; please read the guide on switchd configuration                                                                          |
...
| /etc/lldpd.conf                 | Link Layer Discover Protocol (LLDP) daemon configuration                                                                                                                                                                                                                                                              | [Link Layer Discovery Protocol](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)     | [packages.debian.org/wheezy/lldpd](https://packages.debian.org/wheezy/lldpd)                                                 |
| /etc/lldpd.d/                   | Configuration directory for `lldpd`                                                                                                                                                                                                                                                                                   | [Link Layer Discovery Protocol](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)     | [packages.debian.org/wheezy/lldpd](https://packages.debian.org/wheezy/lldpd)                                                 |
| /etc/nsswitch.conf              | Name Service Switch (NSS) configuration file                                                                                                                                                                                                                                                                          | [TACACS Plus](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)                       | N/A                                                                                                                          |
| /etc/ssh/                       | SSH configuration files                                                                                                                                                                                                                                                                                               | [SSH for Remote Access](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)             | [wiki.debian.org/SSH](https://wiki.debian.org/SSH)                                                                           |
| /etc/sudoers and /etc/sudoers.d | Best practice is to place these changes in `/etc/sudoers.d/` instead of `/etc/sudoers` itself, as changes in the former directory are not lost on upgrade. Customers upgrading from a release prior to 3.2 (such as 3.1.2) to a 3.2 or later release should be aware the `sudoers` file changed in Cumulus Linux 3.2. | [Using sudo to Delegate Privileges](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/) |                                                                                                                              |
...
pair](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/),
...
Switch
Roles](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/).
...
#### Package Upgrade Notes
  ...
  - If you are using some forms of [network
    virtualization](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/),
    including [VMware
    NSX-V](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)
    or [Midokura
    MidoNet](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/),
...
Cons:
  ...
  - Moving the configuration file can go wrong in various ways:
      ...
      - Identifying all the locations of config data is not always an
        ...
        Configuration
        Data](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/).
...
2.  Install the binary image, following the instructions at [Installing
    a New Cumulus Linux
    Image](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/).
...
[Snapshots](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)
...
Known caveats when migrating files from version 2.x to 3.0 or later:
  ...
  - Some configuration files should never be migrated between versions
    ...
    Migrated](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)
...
1.  Back up the version 2.5.z files.
    ...
    **Optional:** Use the Ansible playbook included with the [Config
    ...
    Configurations](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/)
    for more details.
...
2.  [Install Cumulus Linux 3.0 or later onto the switch using
    ONIE](/Users/dcawley/Docs/Hugo/testDocs/content/version2/Cumulus_Linux_36//Installation_Management/Upgrading_Cumulus_Linux/).
