...
weight: 291
aliases:
 - /display/CL35/Filtering+Learned+MAC+Addresses
 - /pages/viewpage.action?pageId=8357357
slug: Filtering_Learned_MAC_Addresses
pageID: 8357357
...
[ACL](/Netfilter_-_ACLs.html). This is due to how the hardware learns
MAC addresses and occurs before the ACL lookup. This can be a security
or resource problem as the MAC address table has the potential to get
filled with bogus MAC addresses, so a malfunctioning host, network
error, loop or malicious attack on a shared L2 platform can create an
