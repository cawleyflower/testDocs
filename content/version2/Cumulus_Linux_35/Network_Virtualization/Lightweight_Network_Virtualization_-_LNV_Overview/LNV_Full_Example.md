...
reference the [Lightweight Network Virtualization
chapter](/Lightweight_Network_Virtualization_-_LNV_Overview.html) for
more detailed information. This full example uses the **recommended
...
## Related Information
  ...
  - [Detailed LNV Configuration
    Guide](/Lightweight_Network_Virtualization_-_LNV_Overview.html)
