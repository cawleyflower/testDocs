...
slug: LNV_VXLAN_Active-Active_Mode
pageID: 8357503
...
<tr class="even">
<td><p>STP</p></td>
<td><p><a href="/#src-8357503_LNVVXLANActive-ActiveMode-bpdu">BPDU filter and BPDU guard</a> should be enabled in the VXLAN interfaces if <a href="/#">STP</a> is enabled in the bridge that is connected to the VXLAN.<br />
...
The layer 3 fabric can be configured using [BGP](/#) or [OSPF](/#). The
...
each other. The L3 fabric on Cumulus Linux can either be [BGP](/#) or
[OSPF](/#). In this example, OSPF is used to demonstrate full
reachability.
