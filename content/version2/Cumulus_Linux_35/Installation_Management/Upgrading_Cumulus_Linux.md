...
| ------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| /etc/network/             | Network configuration files, most notably `/etc/network/interfaces` and `/etc/network/interfaces.d/` | [Layer 1 and Switch Port Attributes](/Layer_1_and_Switch_Port_Attributes.html)                                                                                                              | N/A                                                                                                                          |
...
| /etc/frr/                 | Routing application (responsible for BGP and OSPF)                                                   | [FRRouting Overview](/FRRouting_Overview.html)                                                                                                                                              | N/A                                                                                                                          |
...
| /etc/cumulus/acl/\*       | Netfilter configuration                                                                              | [Netfilter - ACLs](/Netfilter_-_ACLs.html)                                                                                                                                                  | N/A                                                                                                                          |
...
| /etc/nsswitch.conf              | Name Service Switch (NSS) configuration file                                                                                                                                                                                                                                                                          | [TACACS Plus](/TACACS_Plus.html)                                             | N/A                                                                                                                          |
...
upgrade each switch when it is in the *secondary role*.
...
#### Package Upgrade Notes
  ...
  - If you are using some forms of [network
    virtualization](/Network_Virtualization.html), including [VMware
    NSX-V](/Integrating_Hardware_VTEPs_with_VMware_NSX-V.html) or
    [Midokura
...
[Snapshots](/Using_Snapshots.html) can aid you when upgrading the switch
operating system. Cumulus Linux takes two snapshots automatically during
the upgrade, one right before you run `apt-get upgrade`, and one right
after. This way, if something goes wrong with the upgrade, or you need
to revert to the earlier version, you can roll back to the snapshot.
