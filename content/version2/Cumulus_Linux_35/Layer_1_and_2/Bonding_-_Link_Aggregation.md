...
weight: 117
aliases:
 - /display/CL35/Bonding+-+Link+Aggregation
 - /pages/viewpage.action?pageId=8357435
slug: Bonding_-_Link_Aggregation
pageID: 8357435
...
<td><p>Enables <a href="/LACP_Bypass.html">LACP bypass</a>.</p></td>
<td><p>N/A</p></td>
</tr>
<tr class="odd">
<td><p><code>bond lacp-rate</code></p></td>
<td><p>Sets the rate to ask the link partner to transmit LACP control packets.</p>
<p>You can set the LACP rate to slow using <a href="/Network_Command_Line_Utility_-_NCLU.html">NCLU</a>:</p>
<pre><code>                   
...
[MLAG](/Multi-Chassis_Link_Aggregation_-_MLAG.html) environment, the
`clag_id` parameter **must** be configured on the MLAG bonds and must be
the same on both MLAG switches. Otherwise, the bonds are treated by the
MLAG switch pair as if they were single-connected.
