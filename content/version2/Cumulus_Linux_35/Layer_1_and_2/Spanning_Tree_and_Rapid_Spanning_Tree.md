...
slug: Spanning_Tree_and_Rapid_Spanning_Tree
pageID: 8357467
...
[NCLU](/Network_Command_Line_Utility_-_NCLU.html), the network command
line utility for configuring Cumulus Linux, only supports bridges in
VLAN-aware mode.
...
<p>{{%notice note%}}</p>
<p>This setting only applies to a bridge in <a href="/Traditional_Mode_Bridges.html">traditional mode</a>; it does not apply to <a href="/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments.html">VLAN-aware bridges</a>.</p>
<p>{{%/notice%}}</p></td>
</tr>
<tr class="even">
