...
slug: Interface_Configuration_and_Management
pageID: 8357667
...
You can use [NCLU](/Network_Command_Line_Utility_-_NCLU.html) to put an
interface into an admin down state. The interface remains down after any
future reboots or applying configuration changes with `ifreload -a`. For
example:
...
link speed, and so forth](/Layer_1_and_Switch_Port_Attributes.html). And
if you need to delete a child interface, you should delete all
