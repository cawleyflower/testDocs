...
slug: Layer_1_and_Switch_Port_Attributes
pageID: 8357670
...
[NCLU](/Network_Command_Line_Utility_-_NCLU.html) — see the relevant
...
QSFP28 optic defaults to 100G, while a QSFP+ optic defaults to 40G and
SFP+ defaults to 10G.
...
separately using [NCLU](/Network_Command_Line_Utility_-_NCLU.html).
...
<li><p><a href="/Power_over_Ethernet_-_PoE.html">Power over Ethernet</a> may require auto-negotiation to be ON.</p></li>
</ul></td>
</tr>
<tr class="odd">
<td><p>1000BASE-T<br />
...
you are working with [VXLANs](/Network_Virtualization.html), the MTU for
...
[NCLU](/Network_Command_Line_Utility_-_NCLU.html) or `ethtool` to set
the speed instead of hand editing the `ports.conf` file.
