...
redundancy (VRR)](/Virtual_Router_Redundancy_-_VRR.html) on the SVI,
then you must include the VRR interface in the `INTF_CMD` field in the
`/etc/default/isc-dhcp-relay` file. For example:
