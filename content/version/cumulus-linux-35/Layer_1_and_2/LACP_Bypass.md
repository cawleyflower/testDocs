...
weight: 123
aliases:
 - /display/CL35/LACP+Bypass
 - /pages/viewpage.action?pageId=8357472
pageID: 8357472
...
Keep in the mind the following caveats with all-active mode:
  ...
  - Spanning tree protocol (STP) does not run on the individual bond
    ...
    guard](Spanning_Tree_and_Rapid_Spanning_Tree.html#src-8357467_SpanningTreeandRapidSpanningTree-bpdu)
...
In an [MLAG
deployment](/version/cumulus-linux-35/Layer_1_and_2/Multi-Chassis_Link_Aggregation_-_MLAG)
