...
2.  Add a new stanza to create the bridge, and save the file. The
    ...
    <p>For more information on spanning-tree configurations see the configuration section: <a href="/version/cumulus-linux-35/Layer_1_and_2/Spanning_Tree_and_Rapid_Spanning_Tree">Spanning Tree and Rapid Spanning Tree</a>.</p></td>
    <td><p>off</p></td>
    </tr>
    </tbody>
    </table>
...
## <span id="src-8357452_TraditionalModeBridges-VLAN_tagging" class="confluence-anchor-link"></span><span>Using Trunks in Traditional Bridge Mode</span>
...
chapter](/version/cumulus-linux-35/Layer_1_and_2/Ethernet_Bridging_-_VLANs/VLAN_Tagging).

### <span id="src-8357452_TraditionalModeBridges-arp" class="confluence-anchor-link"></span><span>Configuring ARP Timers</span>
