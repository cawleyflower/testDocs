...
weight: 15
aliases:
 - /display/RMP25ESR/Configuring+and+Managing+Network+Interfaces
 - /pages/viewpage.action?pageId=5116354
pageID: 5116354
product: Cumulus RMP
version: 2.5.12
...
For more information on network interfaces, see [Configuring Switch Port
Attributes](/version/cumulus-rmp-2512-esr/Configuring_and_Managing_Network_Interfaces/Configuring_Switch_Port_Attributes).
...
To reload all network interfaces marked `auto`, use the `if reload`
...
<span id="src-5116354_ConfiguringandManagingNetworkInterfaces-ip"></span>
...
link speed, and so
forth](/version/cumulus-rmp-2512-esr/Configuring_and_Managing_Network_Interfaces/Configuring_Switch_Port_Attributes).
...
OID](Monitoring_System_Hardware.html#src-5116326_MonitoringSystemHardware-snmp)
IF-MIB::ifAlias.
