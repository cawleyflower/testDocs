...
tagging](Ethernet_Bridging_-_VLANs.html#src-5116341_EthernetBridging-VLANs-vlan_tagging),
...
Cumulus RMP with a traditional Cisco device:
...
mode](/version/cumulus-rmp-2512-esr/Layer_1_and_Layer_2_Features/Ethernet_Bridging_-_VLANs/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments)
...
example, setting the `sysctl` `net.bridge.bridge-allow-multiple-vlans`
to 0.
