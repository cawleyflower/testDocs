...
pageID: 8362103
aliases:
 - /old/Cumulus_Linux_36/Simple_Network_Management_Protocol_(SNMP)_Monitoring.html
...
below](/old/Cumulus_Linux_36/#src-8362103_safe-id-U2ltcGxlTmV0d29ya01hbmFnZW1lbnRQcm90b2NvbChTTk1QKU1vbml0b3JpbmctcGFzc3BlcnNpc3Q)
...
VRF](/old/Cumulus_Linux_36/https://docs.cumulusnetworks.com/display/DOCS/Management+VRF),
...
[FRRouting](/old/Cumulus_Linux_36/FRRouting_Overview.html). To enable
...
<td><p>You can enable FRRouting SNMP support to provide support for OSPF-MIB (RFC-1850), OSPFV3-MIB (RFC-5643), and BGP4-MIB (RFC-1657). See the <a href="/old/Cumulus_Linux_36/#src-8362103_safe-id-U2ltcGxlTmV0d29ya01hbmFnZW1lbnRQcm90b2NvbChTTk1QKU1vbml0b3JpbmctZnJy">FRRouting section</a> above.</p></td>
</tr>
<tr class="even">
...
<td><p>Layer 2 neighbor information from <code>lldpd</code> (you need to <a href="/old/Cumulus_Linux_36/Link_Layer_Discovery_Protocol.html#src-8362145_LinkLayerDiscoveryProtocol-snmp">enable the SNMP subagent</a> in LLDP). You need to start <code>lldpd</code> with the <code>-x</code> option to enable connectivity to <code>snmpd</code> (AgentX).</p></td>
</tr>
<tr class="odd">
...
All the scripts are enabled by default in Cumulus Linux, except for:
  ...
  - `bgp4_pp.py`, which is now handled by
    [FRRouting](/old/Cumulus_Linux_36/FRRouting_Overview.html) instead
  ...
  - `cl_poe_pp.py`, which is disabled by default as only certain
    ...
    over
    Ethernet](/old/Cumulus_Linux_36/Power_over_Ethernet_-_PoE.html).
