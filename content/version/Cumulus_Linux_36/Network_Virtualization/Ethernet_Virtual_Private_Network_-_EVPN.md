...
pageID: 8362224
aliases:
 - /old/Cumulus_Linux_36/Ethernet_Virtual_Private_Network_-_EVPN.html
...
(LNV)](/old/Cumulus_Linux_36/https://docs.cumulusnetworks.com/display/DOCS/Lightweight+Network+Virtualization+-+LNV+Overview)
in Cumulus Linux.
...
plane for [VXLAN](/old/Cumulus_Linux_36/Network_Virtualization.html)
...
features include:
  ...
  - Support for dual-attached hosts via [VXLAN active-active
    mode](/old/Cumulus_Linux_36/LNV_VXLAN_Active-Active_Mode.html). MAC
...
Overview](/old/Cumulus_Linux_36/https://docs.cumulusnetworks.com/display/DOCS/FRRouting+Overview).

{{%/notice%}}

For information about VXLAN routing, including platform and hardware
limitations, see [VXLAN
Routing](/old/Cumulus_Linux_36/VXLAN_Routing.html).
...
needed in [FRRouting](/old/Cumulus_Linux_36/FRRouting_Overview.html).
...
below](/old/Cumulus_Linux_36/#src-8362224_EthernetVirtualPrivateNetwork-EVPN-allvnis).
...
mode](/old/Cumulus_Linux_36/Traditional_Bridge_Mode.html), you must edit
...
Replication
(HER)](/old/Cumulus_Linux_36/Lightweight_Network_Virtualization_Overview.html#src-8362198_LightweightNetworkVirtualizationOverview-head-end).
...
active-active
mode](/old/Cumulus_Linux_36/LNV_VXLAN_Active-Active_Mode.html). Both
switches in the
[MLAG](/old/Cumulus_Linux_36/Multi-Chassis_Link_Aggregation_-_MLAG.html)
...
The active-active configuration, make sure that:
  ...
  - The `clagd-vxlan-anycast-ip` parameter is under the [loopback
    stanza](/old/Cumulus_Linux_36/LNV_VXLAN_Active-Active_Mode.html#src-8362217_LNVVXLANActive-ActiveMode-anycast)
    on both peers.
  ...
  - The
    [VNIs](/old/Cumulus_Linux_36/LNV_VXLAN_Active-Active_Mode.html#src-8362217_LNVVXLANActive-ActiveMode-example)
    are configured identically on both peers. However,
    `vxlan-local-``tunnelip` must be sourced from unique loopback stanza
    IP address of the switch.

  - The
    [peerlink](/old/Cumulus_Linux_36/LNV_VXLAN_Active-Active_Mode.html#src-8362217_LNVVXLANActive-ActiveMode-example)
...
|   |                                                                                                                                                                                                                                                          |
| - | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 | When the switches boot up, ` ifupdown2  `places all VXLAN interfaces in a [PROTO\_DOWN state](/old/Cumulus_Linux_36/#src-8362224_EthernetVirtualPrivateNetwork-EVPN-proto_down). The configured anycast addresses are not yet configured.                |
...
forwarding](/old/Cumulus_Linux_36/Virtual_Routing_and_Forwarding_-_VRF.html)).
...
routing](/old/Cumulus_Linux_36/VXLAN_Routing.html), Cumulus Networks
...
1.  Enable advertisement of EVPN prefix (type-5) routes. Refer to
    ...
    Routes](/old/Cumulus_Linux_36/#src-8362224_EthernetVirtualPrivateNetwork-EVPN-PBR_type5),
    below.
...
The following caveats apply to EVPN in this version of Cumulus Linux:
  ...
  - In a [VXLAN
    active-active](/old/Cumulus_Linux_36/LNV_VXLAN_Active-Active_Mode.html)
