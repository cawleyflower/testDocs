...
pageID: 8362276
aliases:
 - /old/Cumulus_Linux_36/Hybrid_Cloud_Connectivity_with_QinQ_and_VXLANs.html
...
tags](/old/Cumulus_Linux_36/VLAN_Tagging.html) to be inserted into a
...
QinQ is available on the following switches:
  ...
  - Mellanox switches, only with [VLAN-aware
    bridges](/old/Cumulus_Linux_36/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments.html)
...
bridge](/old/Cumulus_Linux_36/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments.html)
...
mode](/old/Cumulus_Linux_36/Traditional_Bridge_Mode.html) (not
VLAN-aware). As such, you cannot use
[NCLU](/old/Cumulus_Linux_36/Network_Command_Line_Utility_-_NCLU.html)
to configure it.
