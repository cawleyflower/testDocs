...
pageID: 8362315
aliases:
 - /old/Cumulus_Linux_36/Integrating_Hardware_VTEPs_with_VMware_NSX-V.html
...
### Caveats and Errata
  ...
  - There is no support for [VXLAN
    routing](/old/Cumulus_Linux_36/VXLAN_Routing.html) in the Trident II
    chipset; use a loopback interface
    ([hyperloop](/old/Cumulus_Linux_36/VXLAN_Routing.html#src-8362239_VXLANRouting-t2))
    instead.
