...
pageID: 8362394
aliases:
 - /old/Cumulus_Linux_36/Open_Shortest_Path_First_v3_-_OSPFv3_-_Protocol.html
...
[FRR](/old/Cumulus_Linux_36/FRRouting_Overview.html) does not support it
yet.
...
1.  Enabling the `zebra` and `ospf6` daemons, as described in
    [Configuring
    FRRouting](/old/Cumulus_Linux_36/Configuring_FRRouting.html) then
...
See [Debugging
OSPF](/old/Cumulus_Linux_36/Open_Shortest_Path_First_-_OSPF_-_Protocol.html#src-8362392_OpenShortestPathFirst-OSPF-Protocol-ospf_debug)
...
## Related Information
  ...
  - [Auto-cost reference
    bandwidth](/old/Cumulus_Linux_36/Open_Shortest_Path_First_-_OSPF_-_Protocol.html#src-8362392_OpenShortestPathFirst-OSPF-Protocol-acrb)
    (OSPFv2 chapter)
