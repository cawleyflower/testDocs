...
pageID: 8362412
aliases:
 - /old/Cumulus_Linux_36/Virtual_Routing_and_Forwarding_-_VRF.html
...
characteristics:
  ...
  - Applications can use existing interfaces to operate in a VRF context
    ...
    VRF](/old/Cumulus_Linux_36/Management_VRF.html) is enabled, logins
  ...
  - Listen sockets used by services are VRF-global by default unless the
    ...
    VRF](/old/Cumulus_Linux_36/Management_VRF.html#src-8362410_ManagementVRF-services).
...
interfaces. Keep in mind the following for a VRF table:
  ...
  - Names for VRF tables can be up to 15 characters. However, you
    **cannot** use the name *mgmt*, as this name can **only** be used
    for [management VRF](/old/Cumulus_Linux_36/Management_VRF.html).
...
chapter](/old/Cumulus_Linux_36/Management_VRF.html#src-8362410_ManagementVRF-services)
...
[OSPFv2](/old/Cumulus_Linux_36/Open_Shortest_Path_First_-_OSPF_-_Protocol.html)
and [static routing](/old/Cumulus_Linux_36/Routing.html) (IPv4 and IPv6)
...
[FRRouting](/old/Cumulus_Linux_36/FRRouting_Overview.html) learns of
...
FRRouting too, but they become active only when configured with NCLU.
  ...
  - Static routes (IPv4 and IPv6) can be provisioned in a VRF by
    ...
    above](/old/Cumulus_Linux_36/#src-8362412_VirtualRoutingandForwarding-VRF-leakstatic).
...
configurations](/old/Cumulus_Linux_36/Border_Gateway_Protocol_-_BGP.html)
...
## Caveats and Errata
  ...
  - You cannot configure [EVPN address
    families](/old/Cumulus_Linux_36/Ethernet_Virtual_Private_Network_-_EVPN.html)
    within a VRF.
