...
pageID: 8362428
aliases:
 - /old/Cumulus_Linux_36/Segment_Routing.html
...
[BGP](/old/Cumulus_Linux_36/Border_Gateway_Protocol_-_BGP.html) for
label exchange. However, Cumulus Linux does not provide LDP
...
Segment routing supports the following features:
  ...
  - [FRRouting](/old/Cumulus_Linux_36/FRRouting_Overview.html) support
    for MPLS transit label switched paths (LSPs) and labeled routes
    (LER), both static routes and routes using BGP labeled-unicast (LU).
...
[FRR](/old/Cumulus_Linux_36/Configuring_FRRouting.html). The default
