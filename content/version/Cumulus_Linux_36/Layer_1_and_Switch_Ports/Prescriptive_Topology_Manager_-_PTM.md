...
pageID: 8362487
aliases:
 - /old/Cumulus_Linux_36/Prescriptive_Topology_Manager_-_PTM.html
...
## Supported Features
  ...
  - User configuration via a `topology.dot` file; [see
    below](/old/Cumulus_Linux_36/#src-8362487_PrescriptiveTopologyManager-PTM-configuring).
...
below](/old/Cumulus_Linux_36/#src-8362487_PrescriptiveTopologyManager-PTM-ptmd_commands).
...
chapter](/old/Cumulus_Linux_36/Bidirectional_Forwarding_Detection_-_BFD.html).
