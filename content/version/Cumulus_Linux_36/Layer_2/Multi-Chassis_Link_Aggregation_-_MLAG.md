...
pageID: 8362169
aliases:
 - /old/Cumulus_Linux_36/Multi-Chassis_Link_Aggregation_-_MLAG.html
...
MLAG has these requirements:
  ...
  - The dual-connected devices (servers or switches) can use LACP (IEEE
    ...
    [bond](/old/Cumulus_Linux_36/Bonding_-_Link_Aggregation.html). In
    ...
    [balance-xor
    mode](/old/Cumulus_Linux_36/Bonding_-_Link_Aggregation.html#src-8362148_Bonding-LinkAggregation-balance_xor)
...
mode](/old/Cumulus_Linux_36/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments.html).
...
use](/old/Cumulus_Linux_36/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments.html#src-8362167_VLAN-awareBridgeModeforLarge-scaleLayer2Environments-range).
...
mode](/old/Cumulus_Linux_36/Traditional_Bridge_Mode.html) instead of
[VLAN-aware
mode](/old/Cumulus_Linux_36/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments.html).
...
[untagged/native](/old/Cumulus_Linux_36/Traditional_Bridge_Mode.html)
...
or [management VRF](/old/Cumulus_Linux_36/Management_VRF.html). Include
the name of the VRF or management VRF with the ` clagd-backup-ip
...
or [BGP](/old/Cumulus_Linux_36/Border_Gateway_Protocol_-_BGP.html) — to
use. When enabling a routing protocol in an MLAG environment, it is also
...
[IGMP snooping](/old/Cumulus_Linux_36/IGMP_and_MLD_Snooping.html)
...
Snooping](/old/Cumulus_Linux_36/IGMP_and_MLD_Snooping.html) chapter.
...
MLAG](/old/Cumulus_Linux_36/#src-8362169_Multi-ChassisLinkAggregation-MLAG-configuring)
section.

### Understanding MTU in an MLAG Configuration

The [MTU](/old/Cumulus_Linux_36/Switch_Port_Attributes.html) in MLAG
traffic is determined by the bridge MTU. Bridge MTU is determined by the
lowest MTU setting of an interface that is a member of the bridge. If
you want to set an MTU other than the default of 1500 bytes, you must
configure the MTU on each physical interface and bond interface that are
members of the MLAG bridges in the entire bridged domain.
...
`mtu 9216`](/old/Cumulus_Linux_36/Switch_Port_Attributes.html) for each
of the following bond interfaces, as they are members of bridge
...
Assurance](/old/Cumulus_Linux_36/Spanning_Tree_and_Rapid_Spanning_Tree.html#src-8362181_SpanningTreeandRapidSpanningTree-bpdu).
