...
pageID: 8362161
aliases:
 - /old/Cumulus_Linux_36/Traditional_Bridge_Mode.html
...
2.  Add a new stanza to create the bridge, and save the file. The
    ...
    <p>For more information on spanning-tree configurations see the configuration section: <a href="/old/Cumulus_Linux_36/Spanning_Tree_and_Rapid_Spanning_Tree.html">Spanning Tree and Rapid Spanning Tree</a>.</p></td>
    <td><p>off</p></td>
    </tr>
    </tbody>
    </table>
...
chapter](/old/Cumulus_Linux_36/VLAN_Tagging.html).
