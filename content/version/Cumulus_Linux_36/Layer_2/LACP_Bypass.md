...
pageID: 8362186
aliases:
 - /old/Cumulus_Linux_36/LACP_Bypass.html
imgData: Cumulus_Linux_36
siteSlug: Cumulus_Linux_36
---
On Cumulus Linux, *LACP Bypass* is a feature that allows a
[bond](/old/Cumulus_Linux_36/Bonding_-_Link_Aggregation.html) configured
...
Keep in the mind the following caveats with all-active mode:
  ...
  - Spanning tree protocol (STP) does not run on the individual bond
    ...
    guard](/old/Cumulus_Linux_36/Spanning_Tree_and_Rapid_Spanning_Tree.html#src-8362181_SpanningTreeandRapidSpanningTree-bpdu)
...
In an [MLAG
deployment](/old/Cumulus_Linux_36/Multi-Chassis_Link_Aggregation_-_MLAG.html)
