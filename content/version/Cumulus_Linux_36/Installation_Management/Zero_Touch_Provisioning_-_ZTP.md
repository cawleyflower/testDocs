...
pageID: 8362127
aliases:
 - /old/Cumulus_Linux_36/Zero_Touch_Provisioning_-_ZTP.html
...
3.  The contents of the script are parsed to ensure it contains the
    ...
    scripts](/old/Cumulus_Linux_36/#src-8362127_ZeroTouchProvisioning-ZTP-example_scripts)).
...
4.  The zero touch provisioning process requests the contents of the
    ...
    headers](/old/Cumulus_Linux_36/#src-8362127_ZeroTouchProvisioning-ZTP-http_headers)
