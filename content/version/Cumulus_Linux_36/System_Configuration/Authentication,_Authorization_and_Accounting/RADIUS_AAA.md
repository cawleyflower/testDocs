...
pageID: 8362054
aliases:
 - /old/Cumulus_Linux_36/RADIUS_AAA.html
...
4.  Set the `vrf-name` field. This is typically set to *mgmt* if you are
    using a [management VRF](/old/Cumulus_Linux_36/Management_VRF.html).
...
## Related Information
  ...
  - [TACACS+ client](/old/Cumulus_Linux_36/TACACS_Plus.html)
