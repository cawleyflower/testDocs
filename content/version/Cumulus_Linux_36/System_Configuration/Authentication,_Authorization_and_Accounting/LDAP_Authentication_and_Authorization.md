...
pageID: 8362051
aliases:
 - /old/Cumulus_Linux_36/LDAP_Authentication_and_Authorization.html
...
questions using
`debconf-set-selections`](/old/Cumulus_Linux_36/attachments_8362050_1_kb_debconf.txt)
.
...
Here is an [example
configuration ](/old/Cumulus_Linux_36/attachments_8362052_1_nslcd.conf)using
Cumulus Linux.
