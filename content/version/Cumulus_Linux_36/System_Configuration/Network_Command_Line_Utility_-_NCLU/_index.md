...
pageID: 8362075
aliases:
 - /old/Cumulus_Linux_36/Network_Command_Line_Utility_-_NCLU.html
...
configuration with the following commands:
  ...
  - `net commit permanent` retains the
    [snapshot](/old/Cumulus_Linux_36/Using_Snapshots.html) taken when
  ...
  - `net del all` deletes all configurations and stops the IEEE 802.1X
    ...
    VRF](/old/Cumulus_Linux_36/Management_VRF.html) configurations, as
...
[TACACS](/old/Cumulus_Linux_36/TACACS_Plus.html) or
[RADIUS](/old/Cumulus_Linux_36/RADIUS_AAA.html) account name.
...
group](/old/Cumulus_Linux_36/TACACS_Plus.html#src-8362053_TACACSPlus-nclu).
