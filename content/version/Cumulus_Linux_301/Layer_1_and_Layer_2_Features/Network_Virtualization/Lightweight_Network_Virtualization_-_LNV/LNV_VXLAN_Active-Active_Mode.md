...
weight: 321
aliases:
 - /display/CL30/LNV+VXLAN_Active-Active_Mode
...
<td><p>Refer to the <a href="/Open_Shortest_Path_First_-_OSPF_-_Protocol.html">OSPF chapter</a> or the <a href="/Border_Gateway_Protocol_-_BGP.html">BGP chapter</a> for more detailed configuration information. Configurations for the demonstration are provided below.</p></td>
</tr>
<tr class="odd">
<td><p>LNV</p></td>
<td><p>Refer to the <a href="/#">LNV chapter</a> for more detailed configuration information. Configurations for the demonstration are provided below.</p></td>
</tr>
<tr class="even">
<td><p>STP</p></td>
<td><p><a href="/#src-5118334_LNVVXLANActive-ActiveMode-bpdu">BPDU filter and BPDU guard</a> should be enabled in the VXLAN interfaces if <a href="/#">STP</a> is enabled in the bridge that is connected to the VXLAN.<br />
...
LNV](/Lightweight_Network_Virtualization_-_LNV.html#src-5118319_LightweightNetworkVirtualization-LNV-VerificationandTroubleshooting),
...
## Caveats and Errata
  ...
  - [VLAN-aware bridge mode](/#) is not supported for VXLAN
    active-active mode in this release.
...
## See Also
  ...
  - [Lightweight Network
    Virtualization](/Lightweight_Network_Virtualization_-_LNV.html)

  - [LNV Full Example (Single Attached)](/LNV_Full_Example.html)
