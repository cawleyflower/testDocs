...
weight: 237
aliases:
 - /display/CL30/VLAN-aware+Bridge_Mode_for_Large-scale_Layer_2_Environments
...
[Spanning Tree](/Spanning_Tree_and_Rapid_Spanning_Tree.html). Each
...
## Caveats and Errata
  ...
  - **STP:** Because [Spanning Tree and Rapid Spanning
    Tree](/Spanning_Tree_and_Rapid_Spanning_Tree.html) (STP) are enabled
    ...
    each switch in the spanning tree instance. `mstpd` continues to be
    the user space protocol daemon, and Cumulus Linux supports RSTP.
  ...
  - **VXLANs:** Use the traditional configuration mode for [VXLAN
    configuration](/Static_MAC_Bindings_with_VXLAN.html).
  ...
  - **VLAN translation:** A bridge in VLAN-aware mode cannot have VLAN
    ...
    mode](/Ethernet_Bridging_-_VLANs.html) can utilize VLAN translation.
