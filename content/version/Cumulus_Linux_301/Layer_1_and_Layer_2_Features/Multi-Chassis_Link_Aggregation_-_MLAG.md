...
weight: 107
aliases:
 - /display/CL30/Multi-Chassis+Link_Aggregation_-_MLAG
...
mode](/Ethernet_Bridging_-_VLANs.html) instead of [VLAN-aware
mode](/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments.html).
...
3: swp1:  mtu 1500 qdisc pfifo_fast master host-bond1 state DOWN mode DEFAULT qlen 500 protodown on
