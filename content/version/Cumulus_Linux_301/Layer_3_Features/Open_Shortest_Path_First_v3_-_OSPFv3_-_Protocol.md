...
weight: 139
aliases:
 - /display/CL30/Open+Shortest_Path_First_v3_-_OSPFv3_-_Protocol
...
Protocol](/Open_Shortest_Path_First_-_OSPF_-_Protocol.html) for a
...
families (that is, both IPv6 and IPv4). [Quagga](/Quagga_Overview.html)
...
1.  Enabling the `zebra` and `ospf6` daemons, as described in
    [Configuring Quagga](/Configuring_Quagga.html), then start the
    Quagga service:
...
See [Debugging
OSPF](/Open_Shortest_Path_First_-_OSPF_-_Protocol.html#src-5118389_OpenShortestPathFirst-OSPF-Protocol-ospf_debug)
