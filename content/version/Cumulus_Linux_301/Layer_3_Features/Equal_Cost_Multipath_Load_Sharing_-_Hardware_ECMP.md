...
weight: 145
aliases:
 - /display/CL30/Equal+Cost_Multipath_Load_Sharing_-_Hardware_ECMP
...
section](/Border_Gateway_Protocol_-_BGP.html#src-5118393_BorderGatewayProtocol-BGP-ecmp)
...
<span id="src-5118395_EqualCostMultipathLoadSharing-HardwareECMP-hashfields"></span>fields:
...
<span id="src-5118395_EqualCostMultipathLoadSharing-HardwareECMP-resilient_hashing"></span>
...
Resilient hashing is not supported on switches with [Spectrum
...
3.  [Restart](https://docs.cumulusnetworks.com/display/DOCS/Configuring+switchd#Configuringswitchd-restartswitchd)
    the `switchd` service:
...
Resilient hashing is only supported on switches with the [Tomahawk,
Trident II+ and Trident II chipsets](http://cumulusnetworks.com/hcl/).
