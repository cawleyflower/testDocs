...
weight: 205
aliases:
 - /display/CL30/Upgrading+Cumulus_Linux
...
| ------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| /etc/network/             | Network configuration files, most notably `/etc/network/interfaces` and `/etc/network/interfaces.d/` | [Configuring and Managing Network Interfaces](/Configuring_and_Managing_Network_Interfaces.html)                                                                                            | [wiki.debian.org/NetworkConfiguration](https://wiki.debian.org/NetworkConfiguration)                                         |
...
| /etc/quagga/              | Routing application (responsible for BGP and OSPF)                                                   | [Quagga Overview](/Quagga_Overview.html)                                                                                                                                                    | [packages.debian.org/wheezy/quagga](https://packages.debian.org/wheezy/quagga)                                               |
...
| /etc/cumulus/switchd.conf | Switchd configuration                                                                                | [Configuring switchd](/Configuring_switchd.html)                                                                                                                                            | N/A; please read the guide on switchd configuration                                                                          |
...
| /etc/lldpd.conf        | Link Layer Discover Protocol (LLDP) daemon configuration | [Link Layer Discovery Protocol](/Link_Layer_Discovery_Protocol.html)                 | [packages.debian.org/wheezy/lldpd](https://packages.debian.org/wheezy/lldpd)                                                 |
| /etc/lldpd.d/          | Configuration directory for `lldpd`                      | [Link Layer Discovery Protocol](/Link_Layer_Discovery_Protocol.html)                 | [packages.debian.org/wheezy/lldpd](https://packages.debian.org/wheezy/lldpd)                                                 |
| /etc/nsswitch.conf     | Name Service Switch (NSS) configuration file             | [LDAP Authentication and Authorization](/LDAP_Authentication_and_Authorization.html) | [wiki.debian.org/LDAP/NSS](https://wiki.debian.org/LDAP/NSS)                                                                 |
| /etc/ssh/              | SSH configuration files                                  | [SSH for Remote Access](/SSH_for_Remote_Access.html)                                 | [wiki.debian.org/SSH](https://wiki.debian.org/SSH)                                                                           |
| /etc/ldap/ldap.conf    | Lightweight Directory Access Protocol configuration file | [LDAP Authentication and Authorization](/LDAP_Authentication_and_Authorization.html) | [www.debian.org/doc/manuals/debian-reference/ch04.en.html](https://www.debian.org/doc/manuals/debian-reference/ch04.en.html) |
...
pair](/Multi-Chassis_Link_Aggregation_-_MLAG.html), you should only
upgrade each switch when it is in the *secondary role*. The upgrade path
is as follows:
...
2.  [Install Cumulus Linux 3.0 onto the switch using
    ONIE](/Installing_a_New_Cumulus_Linux_Image.html).
