...
weight: 309
aliases:
 - /display/CL30/Monitoring+System_Statistics_and_Network_Traffic_with_sFlow
 - /pages/viewpage.action?pageId=0
slug: /Cumulus_Linux_301//Monitoring_and_Troubleshooting/Network_Troubleshooting
pageID: 5118233
...
From Cumulus Linux 2.5.3 onwards, the sampling rate is limited to 16k
pps. This can be configured by editing the
