...
slug: /Cumulus_Linux_301//Monitoring_and_Troubleshooting
pageID: 5118245
...
| CUMULUS-RESOURCE-QUERY-MIB                                                                                 | Cumulus Linux includes its own resource utilization MIB, which is similar to using [cl-resource-query](/Resource_Diagnostics_Using_cl-resource-query.html). It monitors L3 entries by host, route, nexthops, ECMP groups and L2 MAC/BDPU entries. The MIB is defined in `/usr/share/snmp/mibs/Cumulus-Resource-Query-MIB.txt`, and has the OID `.1.3.6.1.4.1.40310.1.` |
