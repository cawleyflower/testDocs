...
bridge](/version/cumulus-rmp-321/Layer_1_and_Layer_2_Features/Ethernet_Bridging_-_VLANs/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments)
...
2.  Add a new stanza to create the bridge, and save the file. The
    ...
    <p>For more information on spanning-tree configurations see the configuration section: <a href="/version/cumulus-rmp-321/Layer_1_and_Layer_2_Features/Spanning_Tree_and_Rapid_Spanning_Tree">Spanning Tree and Rapid Spanning Tree</a>.</p></td>
    <td><p>off</p></td>
    </tr>
    </tbody>
    </table>
...
## <span id="src-5127612_TraditionalModeBridges-VLAN_tagging" class="confluence-anchor-link"></span><span>Using Trunks in Traditional Bridge Mode</span>
...
chapter](/version/cumulus-rmp-321/Layer_1_and_Layer_2_Features/Ethernet_Bridging_-_VLANs/VLAN_Tagging).
