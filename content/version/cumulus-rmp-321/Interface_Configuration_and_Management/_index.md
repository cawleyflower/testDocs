...
weight: 15
aliases:
 - /display/RMP321/Interface+Configuration+and+Management
 - /pages/viewpage.action?pageId=5127616
pageID: 5127616
product: Cumulus RMP
version: 3.2.1
...
Attributes](/version/cumulus-rmp-321/Interface_Configuration_and_Management/Layer_1_and_Switch_Port_Attributes).
...
## <span id="src-5127616_InterfaceConfigurationandManagement-classes" class="confluence-anchor-link"></span><span>ifupdown2 Interface Classes</span>
...
<span id="src-5127616_InterfaceConfigurationandManagement-ip"></span>
...
link speed, and so
forth](/version/cumulus-rmp-321/Interface_Configuration_and_Management/Layer_1_and_Switch_Port_Attributes).
...
**Example post-up Configuration**
    ...
    cumulus@switch:~$ net add interface swp6 post-up ip address add 71.21.21.20/32 dev swp6
...
Errata](#src-5127616_InterfaceConfigurationandManagement-caveats)
...
OID](Monitoring_System_Hardware.html#src-5127559_MonitoringSystemHardware-snmp)
...
## <span id="src-5127616_InterfaceConfigurationandManagement-caveats" class="confluence-anchor-link"></span><span>Caveats and Errata</span>
