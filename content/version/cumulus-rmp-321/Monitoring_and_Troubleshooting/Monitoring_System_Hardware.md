...
You monitor system hardware in these ways, using:
  ...
  - [Net-SNMP](/version/cumulus-rmp-321/Monitoring_and_Troubleshooting/SNMP_Monitoring/)
...
## <span id="src-5127559_MonitoringSystemHardware-snmp" class="confluence-anchor-link"></span><span>Monitoring Switch Hardware Using SNMP</span>

You can read about Net-SNMP in [this
chapter](/version/cumulus-rmp-321/Monitoring_and_Troubleshooting/SNMP_Monitoring/).
...
## <span id="src-5127559_MonitoringSystemHardware-watchdog" class="confluence-anchor-link"></span><span>Keeping the Switch Alive Using the Hardware Watchdog</span>
