...
weight: 17
aliases:
 - /display/CL321/Interface+Configuration+and+Management
 - /pages/viewpage.action?pageId=5126993
pageID: 5126993
...
Attributes](/version/cumulus-linux-321/Interface_Configuration_and_Management/Layer_1_and_Switch_Port_Attributes).
...
## <span id="src-5126993_InterfaceConfigurationandManagement-classes" class="confluence-anchor-link"></span><span>ifupdown2 Interface Classes</span>
...
[Management VRF](/version/cumulus-linux-321/Layer_Three/Management_VRF),
you can use the special interface class called *mgmt*, and put the
...
## <span id="src-5126993_InterfaceConfigurationandManagement-ip" class="confluence-anchor-link"></span><span>ifupdown Behavior with Child Interfaces</span>
...
link speed, and so
forth](/version/cumulus-linux-321/Interface_Configuration_and_Management/Layer_1_and_Switch_Port_Attributes).
...
## <span id="src-5126993_InterfaceConfigurationandManagement-ip" class="confluence-anchor-link"></span><span>Configuring IP Addresses</span>
...
Errata](#src-5126993_InterfaceConfigurationandManagement-caveats)
...
You can query the interface description using NCLU. The alias appears in
the **Name** column after the actual interface name:
...
OID](Monitoring_System_Hardware.html#src-5126776_MonitoringSystemHardware-snmp)
...
## <span id="src-5126993_InterfaceConfigurationandManagement-caveats" class="confluence-anchor-link"></span><span>Caveats and Errata</span>
