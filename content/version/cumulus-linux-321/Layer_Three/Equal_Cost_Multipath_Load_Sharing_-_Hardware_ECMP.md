...
section](Border_Gateway_Protocol_-_BGP.html#src-5127049_BorderGatewayProtocol-BGP-ecmp)
...
3.  [Restart](Configuring_switchd.html#src-5126758_Configuringswitchd-restartswitchd)
    the `switchd` service:
