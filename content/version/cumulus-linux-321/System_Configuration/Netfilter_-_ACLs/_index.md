...
weight: 63
aliases:
 - /display/CL321/Netfilter+-+ACLs
 - /pages/viewpage.action?pageId=5126760
pageID: 5126760
...
{{% imgOld 5 %}}
  ...
  - **Target(s):** The *target* can be a user-defined chain (other than
    ...
    Usages](#src-5126760_Netfilter-ACLs-supported) section below for
...
### <span id="src-5126760_Netfilter-ACLs-nonatomic" class="confluence-anchor-link"></span><span>Enabling Nonatomic Updates</span>
...
listed [later in this chapter](#src-5126760_Netfilter-ACLs-exm).
...
([see above](#src-5126760_Netfilter-ACLs-nonatomic)).
...
## <span id="src-5126760_Netfilter-ACLs-supported" class="confluence-anchor-link"></span><span>Supported Rule Types</span>
...
<li><p>IP common: tcp (<a href="#src-5126760_Netfilter-ACLs-filteringtcp">with flags</a>), udp, multiport,TOS, DSCP, addrtype</p></li>
</ul></td>
<td><ul>
...
### <span id="src-5126760_Netfilter-ACLs-filteringtcp" class="confluence-anchor-link"></span><span>Filtering Specific TCP Flags</span>
...
<span id="src-5126760_Netfilter-ACLs-examples"></span>The following
...
section](#src-5126760_Netfilter-ACLs-supported) above, not all
