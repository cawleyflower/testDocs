...
|   |                                                                                                                                                                                                                                                          |
| - | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1 | When the switches boot up, ` ifupdown2  `places all VXLAN interfaces in a [PROTO\_DOWN state](/old/Cumulus_Linux_35/#src-8357503_LNVVXLANActive-ActiveMode-proto_down). The configured anycast addresses are not configured yet.                         |
...
[Cumulus VX
documentation](/old/Cumulus_Linux_35/https://docs.cumulusnetworks.com/display/VX).

## Troubleshooting with LNV Active-Active

In addition to the [troubleshooting for single-attached
LNV](/old/Cumulus_Linux_35/https://docs.cumulusnetworks.com/display/DOCS/Lightweight+Network+Virtualization+-+LNV#LightweightNetworkVirtualization-LNV-VerificationandTroubleshooting),
...
## Caveats and Errata
  ...
  - The VLAN used for the peer link layer 3 subinterface should not be
    ...
    [the section
    above](/old/Cumulus_Linux_35/#src-8357503_LNVVXLANActive-ActiveMode-range).
...
## Related Information
  ...
  - [Network virtualization chapter, Cumulus Linux user
    guide](/old/Cumulus_Linux_35/Network_Virtualization.html)
      ...
      - [Lightweight Network Virtualization - LNV
        Overview](/old/Cumulus_Linux_35/Lightweight_Network_Virtualization_-_LNV_Overview.html)
          ...
          - [LNV VXLAN Active-Active Mode](/old/Cumulus_Linux_35/#)
