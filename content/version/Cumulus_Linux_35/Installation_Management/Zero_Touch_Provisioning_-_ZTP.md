...
pageID: 8357412
aliases:
 - /old/Cumulus_Linux_35/Zero_Touch_Provisioning_-_ZTP.html
...
3.  The script's contents are parsed to ensure it contains the
    ...
    scripts](/old/Cumulus_Linux_35/#src-8357412_ZeroTouchProvisioning-ZTP-example_scripts)).
...
4.  The zero touch provisioning process requests the contents of the
    ...
    headers](/old/Cumulus_Linux_35/#src-8357412_ZeroTouchProvisioning-ZTP-http_headers)
