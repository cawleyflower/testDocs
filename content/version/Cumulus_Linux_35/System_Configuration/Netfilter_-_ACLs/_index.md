...
pageID: 8357345
aliases:
 - /old/Cumulus_Linux_35/Netfilter_-_ACLs.html
...
{{%imgOld 5 %}}
  ...
  - **Target(s):** The *target* can be a user-defined chain (other than
    ...
    Usages](/old/Cumulus_Linux_35/#src-8357345_Netfilter-ACLs-supported)
...
3.  [Restart
    `switchd`](/old/Cumulus_Linux_35/https://docs.cumulusnetworks.com/pages/viewpage.action?pageId=5114824):
...
and [traditional
mode](/old/Cumulus_Linux_35/Traditional_Mode_Bridges.html) bridges,
including bridge SVIs ([switch VLAN
interfaces](/old/Cumulus_Linux_35/Ethernet_Bridging_-_VLANs.html#src-8357437_EthernetBridging-VLANs-svi))
...
chapter](/old/Cumulus_Linux_35/#src-8357345_Netfilter-ACLs-exm).
...
function of the following factors:
  ...
  - Whether the rules are in atomic or nonatomic mode; nonatomic mode
    ...
    above](/old/Cumulus_Linux_35/#src-8357345_Netfilter-ACLs-nonatomic))
...
with the [TCAM
profile](/old/Cumulus_Linux_35/Routing.html#src-8357708_Routing-tcam)
...
section](/old/Cumulus_Linux_35/#src-8357345_Netfilter-ACLs-supported)
above, not all `iptables`, `ip6tables` or `ebtables` rules are
supported. Refer to that section for specific rule support.
...
Then [restart
`switchd`](/old/Cumulus_Linux_35/https://docs.cumulusnetworks.com/display/CL30/Configuring+switchd#Configuringswitchd-restartswitchd).
