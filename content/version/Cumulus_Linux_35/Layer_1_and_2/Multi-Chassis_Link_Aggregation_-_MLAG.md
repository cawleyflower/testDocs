...
MLAG has these requirements:
  ...
  - The dual-connected devices (servers or switches) can use LACP (IEEE
    ...
    [bond](/old/Cumulus_Linux_35/Bonding_-_Link_Aggregation.html). In
    ...
    [balance-xor
    mode](/old/Cumulus_Linux_35/Bonding_-_Link_Aggregation.html#src-8357435_Bonding-LinkAggregation-balance_xor)
...
use](/old/Cumulus_Linux_35/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments.html#src-8357447_VLAN-awareBridgeModeforLarge-scaleLayer2Environments-range).
...
mode](/old/Cumulus_Linux_35/Traditional_Mode_Bridges.html) instead of
[VLAN-aware
mode](/old/Cumulus_Linux_35/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments.html).
...
[untagged/native](/old/Cumulus_Linux_35/Traditional_Mode_Bridges.html)
...
or [management VRF](/old/Cumulus_Linux_35/Management_VRF.html). Include
the name of the VRF or management VRF when you specify `clagd-backup-ip
...
or [BGP](/old/Cumulus_Linux_35/Border_Gateway_Protocol_-_BGP.html) — to
...
layer 3 uplink interfaces. In the event of a peer link failure MLAG does
not remove static routes or bring down a BGP or OSPF adjacency unless a
...
[IGMP snooping](/old/Cumulus_Linux_35/IGMP_and_MLD_Snooping.html)
...
Snooping](/old/Cumulus_Linux_35/IGMP_and_MLD_Snooping.html) chapter.
...
MLAG](/old/Cumulus_Linux_35/#src-8357455_Multi-ChassisLinkAggregation-MLAG-configuring)
section.

### Understanding MTU in an MLAG Configuration

Note that the
[MTU](/old/Cumulus_Linux_35/Layer_1_and_Switch_Port_Attributes.html) in
MLAG traffic is determined by the bridge MTU. Bridge MTU is determined
by the lowest MTU setting of an interface that is a member of the
bridge. If an MTU other than the default of 1500 bytes is desired, you
must configure the MTU on each physical interface and bond interface
...
`mtu 9216`](/old/Cumulus_Linux_35/Layer_1_and_Switch_Port_Attributes.html)
...
Assurance](/old/Cumulus_Linux_35/Spanning_Tree_and_Rapid_Spanning_Tree.html#src-8357467_SpanningTreeandRapidSpanningTree-bpdu).)
