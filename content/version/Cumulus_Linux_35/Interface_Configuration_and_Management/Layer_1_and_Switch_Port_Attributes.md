...
[table
below](/old/Cumulus_Linux_35/#src-8357670_Layer1andSwitchPortAttributes-settings).

Ports are always automatically configured on a Mellanox-based switch,
with one exception — you only need to configure is
[MTU](/old/Cumulus_Linux_35/#src-8357670_Layer1andSwitchPortAttributes-mtu).
...
below](/old/Cumulus_Linux_35/#src-8357670_Layer1andSwitchPortAttributes-sett).
...
(see the [table
below](/old/Cumulus_Linux_35/#src-8357670_Layer1andSwitchPortAttributes-setting)).
...
<li><p><a href="/old/Cumulus_Linux_35/Power_over_Ethernet_-_PoE.html">Power over Ethernet</a> may require auto-negotiation to be ON.</p></li>
</ul></td>
</tr>
<tr class="odd">
<td><p>1000BASE-T<br />
...
below](/old/Cumulus_Linux_35/#src-8357670_Layer1andSwitchPortAttributes-breakout).
...
[VXLANs](/old/Cumulus_Linux_35/Network_Virtualization.html), the MTU for
...
Cumulus Linux has the ability to:
  ...
  - Combine (also called *aggregating* or *ganging*) four 10G switch
    ...
    confused with a
    bond](/old/Cumulus_Linux_35/Bonding_-_Link_Aggregation.html)).
...
services](/old/Cumulus_Linux_35/Configuring_switchd.html#src-8357343_Configuringswitchd-restartswitchd).
...
See [the
note](/old/Cumulus_Linux_35/#src-8357670_Layer1andSwitchPortAttributes-breakout)
above.
