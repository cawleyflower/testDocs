...
stack:
  ...
  - RoCEv1, which runs at the link layer and cannot be run over a routed
    ...
    control](/old/Cumulus_Linux_35/Buffer_and_Queue_Management.html#src-8357678_BufferandQueueManagement-pfc)
    (PFC) to be enabled.

  - RoCEv2, which runs over layer 3. Since it's a routed solution,
    Cumulus Networks recommends you use [explicit congestion
    notification](/old/Cumulus_Linux_35/Buffer_and_Queue_Management.html#src-8357678_BufferandQueueManagement-ecn)
...
[PFC](/old/Cumulus_Linux_35/Buffer_and_Queue_Management.html#src-8357678_BufferandQueueManagement-pfc)
...
While [link
pause](/old/Cumulus_Linux_35/Buffer_and_Queue_Management.html#src-8357678_BufferandQueueManagement-pause)
...
[ECN](/old/Cumulus_Linux_35/Buffer_and_Queue_Management.html#src-8357678_BufferandQueueManagement-ecn)
section of the [Buffer and Queue
Management](/old/Cumulus_Linux_35/Buffer_and_Queue_Management.html)
chapter.
