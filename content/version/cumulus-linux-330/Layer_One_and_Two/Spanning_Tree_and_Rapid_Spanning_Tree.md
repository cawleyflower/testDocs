...
weight: 109
aliases:
 - /display/CL33/Spanning+Tree+and+Rapid+Spanning+Tree
 - /pages/viewpage.action?pageId=5866220
pageID: 5866220
...
mode](/version/cumulus-linux-330/Layer_One_and_Two/Ethernet_Bridging_-_VLANs/)
is in use.

Bridges configured in
*[VLAN-aware](/version/cumulus-linux-330/Layer_One_and_Two/Ethernet_Bridging_-_VLANs/VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments)*
...
guard](#src-5866220_SpanningTreeandRapidSpanningTree-bpdu) feature.
...
### <span id="src-5866220_SpanningTreeandRapidSpanningTree-bpdu" class="confluence-anchor-link"></span><span>BPDU Guard</span>
...
### <span id="src-5866220_SpanningTreeandRapidSpanningTree-params" class="confluence-anchor-link"></span><span>Configuring Other Spanning Tree Parameters</span>
