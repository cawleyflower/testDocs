...
## <span id="src-5866133_NetworkTroubleshooting-counter_acl" class="confluence-anchor-link"></span><span>Creating Counter ACL Rules</span>
...
[Netfilter](/version/cumulus-linux-330/System_Configuration/Netfilter_-_ACLs/)
...
## <span id="src-5866133_NetworkTroubleshooting-span" class="confluence-anchor-link"></span><span>Configuring SPAN and ERSPAN</span>
...
security ACL
configuration](/version/cumulus-linux-330/System_Configuration/Netfilter_-_ACLs/).
The match criteria for SPAN and ERSPAN is usually an interface; for more
granular match terms, use [selective
spanning](#src-5866133_NetworkTroubleshooting-selective_spanning). The
...
[Cut-through
mode](Buffer_and_Queue_Management.html#src-5866397_BufferandQueueManagement-cut_through_mode)
...
### <span id="src-5866133_NetworkTroubleshooting-selective_spanning" class="confluence-anchor-link"></span><span>Selective Spanning</span>
