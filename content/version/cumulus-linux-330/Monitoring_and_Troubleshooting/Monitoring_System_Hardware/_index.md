...
You monitor system hardware in these ways, using:
  ...
  - [Net-SNMP](/version/cumulus-linux-330/Monitoring_and_Troubleshooting/SNMP_Monitoring/)
...
## <span id="src-5866131_MonitoringSystemHardware-snmp" class="confluence-anchor-link"></span><span>Monitoring Switch Hardware Using SNMP</span>

The Net-SNMP documentation is discussed
[here](/version/cumulus-linux-330/Monitoring_and_Troubleshooting/SNMP_Monitoring/).
...
## <span id="src-5866131_MonitoringSystemHardware-watchdog" class="confluence-anchor-link"></span><span>Keeping the Switch Alive Using the Hardware Watchdog</span>
