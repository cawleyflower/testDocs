...
<tr class="odd">
<td><p><strong><a href="/version/cumulus-linux-330/Monitoring_and_Troubleshooting/SNMP_Monitoring/Using_Nutanix_Prism_as_a_Monitoring_Tool">Nutanix Prism CLI</a></strong> (SSH to the cluster IP address)</p></td>
...
## <span id="src-5866145_SNMPMonitoring-supported_mibs" class="confluence-anchor-link"></span><span>Supported MIBs</span>
...
<td><p>L2 neighbor info from <code>lldpd</code> (note, you need to <a href="Link_Layer_Discovery_Protocol.html#src-5866184_LinkLayerDiscoveryProtocol-snmp">enable the SNMP subagent</a> in LLDP). <code>lldpd</code> needs to be started with the <code>-x</code> option to enable connectivity to <code>snmpd</code> (AgentX).</p></td>
</tr>
<tr class="even">
