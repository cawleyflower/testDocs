...
section](Border_Gateway_Protocol_-_BGP.html#src-5866438_BorderGatewayProtocol-BGP-ecmp)
...
3.  [Restart](Configuring_switchd.html#src-5866112_Configuringswitchd-restartswitchd)
    the `switchd` service:
