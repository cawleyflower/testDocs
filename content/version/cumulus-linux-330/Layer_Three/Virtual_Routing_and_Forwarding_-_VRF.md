...
interfaces. Keep in mind the following for a VRF table:
  ...
  - Names for VRF tables can be up to 15 characters. However, you
    **cannot** use the name *mgmt*, as this name can **only** be used
    for [management
    VRF](/version/cumulus-linux-330/Layer_Three/Management_VRF).
...
### <span id="src-5866454_VirtualRoutingandForwarding-VRF-vrf_cmd" class="confluence-anchor-link"></span><span>Using the vrf Command</span>
...
#### <span id="src-5866454_VirtualRoutingandForwarding-VRF-exec" class="confluence-anchor-link"></span><span>Running IPv4 and IPv6 Commands in a VRF Context </span>
...
[Quagga](/version/cumulus-linux-330/Layer_Three/Quagga_Overview) learns
...
configurations](/version/cumulus-linux-330/Layer_Three/Border_Gateway_Protocol_-_BGP)
