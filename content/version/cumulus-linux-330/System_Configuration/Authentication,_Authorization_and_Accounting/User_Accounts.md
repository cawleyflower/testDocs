...
The *cumulus* account:
  ...
  - 
    ...
    <div id="src-5866105_indexterm-8EFCBAC1D7384667892CDAFBB2A08933">
  ...
  - User can log in to the system via all the usual channels like
    console and
    [SSH](/version/cumulus-linux-330/System_Configuration/Authentication_Authorization_and_Accounting/SSH_for_Remote_Access)
...
commands](/version/cumulus-linux-330/System_Configuration/Authentication_Authorization_and_Accounting/Using_sudo_to_Delegate_Privileges),
so be sure to include them in the *sudo* group.

To access the switch without any password requires [booting into a
single shell/user
mode](/version/cumulus-linux-330/Monitoring_and_Troubleshooting/Single_User_Mode_-_Boot_Recovery).
...
### <span id="src-5866105_UserAccounts-ssh_key" class="confluence-anchor-link"></span><span>Generating an SSH Key for the root Account</span>
...
### <span id="src-5866105_UserAccounts-root_passwd" class="confluence-anchor-link"></span><span>Setting the root User Password</span>
