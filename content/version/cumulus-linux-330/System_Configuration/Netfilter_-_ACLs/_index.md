...
weight: 69
aliases:
 - /display/CL33/Netfilter+-+ACLs
 - /pages/viewpage.action?pageId=5866114
pageID: 5866114
...
{{% imgOld 5 %}}
  ...
  - **Target(s):** The *target* can be a user-defined chain (other than
    ...
    Usages](#src-5866114_Netfilter-ACLs-supported) section below for
...
### <span id="src-5866114_Netfilter-ACLs-nonatomic" class="confluence-anchor-link"></span><span>Enabling Nonatomic Updates</span>
...
listed [later in this chapter](#src-5866114_Netfilter-ACLs-exm).
...
The nonatomic mode rules are used when nonatomic updates are enabled
([see above](#src-5866114_Netfilter-ACLs-nonatomic)).
...
### <span>Broadcom Trident II and Helix4 Limits</span>
...
with the [TCAM profile](Routing.html#src-5866425_Routing-tcam) specified
for the switch.
...
## <span id="src-5866114_Netfilter-ACLs-supported" class="confluence-anchor-link"></span><span>Supported Rule Types</span>
...
<li><p>IP common: tcp (<a href="#src-5866114_Netfilter-ACLs-filteringtcp">with flags</a>), udp, multiport,TOS, DSCP, addrtype</p></li>
</ul></td>
<td><ul>
...
### <span id="src-5866114_Netfilter-ACLs-filteringtcp" class="confluence-anchor-link"></span><span>Filtering Specific TCP Flags</span>
...
<span id="src-5866114_Netfilter-ACLs-examples"></span>The following
...
section](#src-5866114_Netfilter-ACLs-supported) above, not all
...
#### <span>Ping-pong Mode Enabled by Default</span>
