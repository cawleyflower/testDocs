...
listed [later in this chapter](#src-5118219_Netfilter-ACLs-exm).
...
function of the platform type (ASIC, such as Tomahawk or Spectrum) and a
mix of IPv4 and/or IPv6. See the
...
## <span id="src-5118219_Netfilter-ACLs-supported" class="confluence-anchor-link"></span><span>Supported Rule Types</span>
...
<li><p>IP common: tcp (<a href="#src-5118219_Netfilter-ACLs-filteringtcp">with flags</a>), udp, multiport,TOS, DSCP, addrtype</p></li>
</ul></td>
<td><ul>
...
### <span id="src-5118219_Netfilter-ACLs-filteringtcp" class="confluence-anchor-link"></span><span>Filtering Specific TCP Flags</span>
...
<span id="src-5118219_Netfilter-ACLs-examples"></span>The following
