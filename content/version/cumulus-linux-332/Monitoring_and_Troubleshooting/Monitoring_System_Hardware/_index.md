...
weight: 209
aliases:
 - /display/CL332/Monitoring+System+Hardware
 - /pages/viewpage.action?pageId=5868912
pageID: 5868912
...
You monitor system hardware in these ways, using:
  ...
  - [Net-SNMP](/version/cumulus-linux-332/Monitoring_and_Troubleshooting/SNMP_Monitoring/)
...
## <span id="src-5868912_MonitoringSystemHardware-snmp" class="confluence-anchor-link"></span><span>Monitoring Switch Hardware Using SNMP</span>

The Net-SNMP documentation is discussed
[here](/version/cumulus-linux-332/Monitoring_and_Troubleshooting/SNMP_Monitoring/).

## <span id="src-5868912_MonitoringSystemHardware-smond" class="confluence-anchor-link"></span><span>Monitoring System Units Using smond</span>
...
## <span id="src-5868912_MonitoringSystemHardware-watchdog" class="confluence-anchor-link"></span><span>Keeping the Switch Alive Using the Hardware Watchdog</span>
