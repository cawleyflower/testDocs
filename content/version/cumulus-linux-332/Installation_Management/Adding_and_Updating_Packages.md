...
<span style="color: #000000;"> Before running any </span> `apt-get`
<span style="color: #000000;"> commands or after changing the </span>
`/etc/apt/sources.list` <span style="color: #000000;"> file </span>
<span style="color: #000000;"> , you need to run </span> `apt-get
update` <span style="color: #000000;"> . </span>
