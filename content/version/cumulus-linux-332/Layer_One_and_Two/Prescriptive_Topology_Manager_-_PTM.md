...
weight: 113
aliases:
 - /display/CL332/Prescriptive+Topology+Manager+-+PTM
 - /pages/viewpage.action?pageId=5868968
pageID: 5868968
...
## <span>Supported Features</span>
  ...
  - Forwarding path failure detection using [Bidirectional Forwarding
    ...
    Detection -
    BFD](/version/cumulus-linux-332/Layer_Three/Bidirectional_Forwarding_Detection_-_BFD)
  ...
  - User configuration via a `topology.dot` file; [see
    below](#src-5868968_PrescriptiveTopologyManager-PTM-configuring).

## <span id="src-5868968_PrescriptiveTopologyManager-PTM-configuring" class="confluence-anchor-link"></span><span>Configuring PTM</span>
...
## <span id="src-5868968_PrescriptiveTopologyManager-PTM-example" class="confluence-anchor-link"></span><span>Basic Topology Example</span>
...
## <span id="src-5868968_PrescriptiveTopologyManager-PTM-advanced" class="confluence-anchor-link"></span><span>ptmd Scripts</span>
...
below](#src-5868968_PrescriptiveTopologyManager-PTM-ptmd_commands).
...
## <span id="src-5868968_PrescriptiveTopologyManager-PTM-bfd" class="confluence-anchor-link"></span><span>Bidirectional Forwarding Detection (BFD)</span>
...
chapter](/version/cumulus-linux-332/Layer_Three/Bidirectional_Forwarding_Detection_-_BFD).

## <span id="src-5868968_PrescriptiveTopologyManager-PTM-quagga" class="confluence-anchor-link"></span><span>Checking Link State with Quagga</span>
...
## <span id="src-5868968_PrescriptiveTopologyManager-PTM-ptmd_commands" class="confluence-anchor-link"></span><span>Using ptmd Service Commands</span>
