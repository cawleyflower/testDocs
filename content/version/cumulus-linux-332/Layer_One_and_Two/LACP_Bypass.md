...
Keep in the mind the following caveats with all-active mode:
  ...
  - Spanning tree protocol (STP) does not run on the individual bond
    ...
    guard](Spanning_Tree_and_Rapid_Spanning_Tree.html#src-5869002_SpanningTreeandRapidSpanningTree-bpdu)
...
In an [MLAG
deployment](/version/cumulus-linux-332/Layer_One_and_Two/Multi-Chassis_Link_Aggregation_-_MLAG)
