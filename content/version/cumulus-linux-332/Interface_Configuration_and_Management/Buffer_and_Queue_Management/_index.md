...
weight: 91
aliases:
 - /display/CL332/Buffer+and+Queue+Management
 - /pages/viewpage.action?pageId=5869179
pageID: 5869179
...
## <span id="src-5869179_BufferandQueueManagement-pfc" class="confluence-anchor-link"></span><span>Configuring Priority Flow Control</span>
...
## <span id="src-5869179_BufferandQueueManagement-pause" class="confluence-anchor-link"></span><span>Configuring Link Pause</span>
...
## <span id="src-5869179_BufferandQueueManagement-cut_through_mode" class="confluence-anchor-link"></span><span>Configuring Cut-through Mode and Store and Forward Switching</span>
...
## <span id="src-5869179_BufferandQueueManagement-ecn" class="confluence-anchor-link"></span><span>Configuring Explicit Congestion Notification</span>
