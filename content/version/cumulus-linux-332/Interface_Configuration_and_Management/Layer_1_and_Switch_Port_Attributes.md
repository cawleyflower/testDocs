...
weight: 89
aliases:
 - /display/CL332/Layer+1+and+Switch+Port+Attributes
 - /pages/viewpage.action?pageId=5869171
pageID: 5869171
...
[table below](#src-5869171_Layer1andSwitchPortAttributes-settings).

Ports are always automatically configured on a Mellanox-based switch,
with one exception — you only need to configure is
[MTU](#src-5869171_Layer1andSwitchPortAttributes-mtu). You don't even
need to enable auto-negotation, as the Mellanox firmware configures
everything for you.

### <span id="src-5869171_Layer1andSwitchPortAttributes-autoneg_enable" class="confluence-anchor-link"></span><span>Enabling Auto-negotiation</span>
...
below](#src-5869171_Layer1andSwitchPortAttributes-sett).
...
(see the [table
below](#src-5869171_Layer1andSwitchPortAttributes-setting)). FEC always
adjusts for the speed of the cable. However, you **cannot** disable FEC
separately using
[NCLU](/version/cumulus-linux-332/System_Configuration/Network_Command_Line_Utility).

### <span id="src-5869171_Layer1andSwitchPortAttributes-settings" class="confluence-anchor-link"></span><span>Default Interface Configuration Settings</span>
...
below](#src-5869171_Layer1andSwitchPortAttributes-breakout).

### <span id="src-5869171_Layer1andSwitchPortAttributes-mtu" class="confluence-anchor-link"></span><span>MTU</span>
...
<span id="src-5869171_Layer1andSwitchPortAttributes-mtu_vxlan"></span>If
you are working with
[VXLANs](/version/cumulus-linux-332/Network_Virtualization/), the MTU
...
### <span>Creating a Default Policy for Interface Settings</span>
...
## <span id="src-5869171_Layer1andSwitchPortAttributes-breakout" class="confluence-anchor-link"></span><span>Configuring Breakout Ports</span>
...
services](Configuring_switchd.html#src-5868885_Configuringswitchd-restartswitchd).
...
For example, if you have a 100G Mellanox SN-2700 switch and break out
...
way. See [the note](#src-5869171_Layer1andSwitchPortAttributes-breakout)
above.

## <span id="src-5869171_Layer1andSwitchPortAttributes-ethtool" class="confluence-anchor-link"></span><span>Using ethtool to Configure Interfaces</span>
...
`switchd`](Configuring_switchd.html#src-5868885_Configuringswitchd-restartswitchd)
