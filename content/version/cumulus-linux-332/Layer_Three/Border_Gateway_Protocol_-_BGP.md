...
## <span id="src-5869220_BorderGatewayProtocol-BGP-ecmp" class="confluence-anchor-link"></span><span>ECMP with BGP</span>
...
## <span id="src-5869220_BorderGatewayProtocol-BGP-config_bgp" class="confluence-anchor-link"></span><span>Configuring BGP</span>
...
1.  Enable the BGP and Zebra daemons, `zebra` and `bgpd`, then enable
    ...
    Quagga](/version/cumulus-linux-332/Layer_Three/Configuring_Quagga/).
...
## <span id="src-5869220_BorderGatewayProtocol-BGP-unnumbered" class="confluence-anchor-link"></span><span>Using BGP Unnumbered Interfaces</span>
...
group](#src-5869220_BorderGatewayProtocol-BGP-peergroups) (making sure
...
## <span id="src-5869220_BorderGatewayProtocol-BGP-add-path" class="confluence-anchor-link"></span><span>BGP add-path</span>
...
## <span id="src-5869220_BorderGatewayProtocol-BGP-peergroups" class="confluence-anchor-link"></span><span>Using Peer Groups to Simplify Configuration</span>
...
using [management
VRF](/version/cumulus-linux-332/Layer_Three/Management_VRF) (multiple
...
(ACLs)](/version/cumulus-linux-332/System_Configuration/Netfilter_-_ACLs/).
...
### <span>Related Information</span>
  ...
  - [Bidirectional forwarding
    detection](/version/cumulus-linux-332/Layer_Three/Bidirectional_Forwarding_Detection_-_BFD)
    (BFD) and BGP
