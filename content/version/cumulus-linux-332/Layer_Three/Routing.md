...
[Quagga](http://www.nongnu.org/quagga/) routing table, and are then
updated into the kernel routing table as well.
...
To view mroutes, open the Quagga CLI, and run the following command:
...
You can use
[`cl-resource-query`](/version/cumulus-linux-332/Monitoring_and_Troubleshooting/Resource_Diagnostics_Using_cl-resource-query)
to determine the current table sizes on a given switch.

### <span id="src-5869207_Routing-uft" class="confluence-anchor-link"></span><span>Forwarding Table Profiles</span>
...
### <span id="src-5869207_Routing-tcam" class="confluence-anchor-link"></span><span>TCAM Resource Profiles for Mellanox Switches</span>
...
After you specify a different profile, [restart
`switchd`](/display/CL332/Configuring+switchd#Configuringswitchd-restartswitchd)
for the change to take effect.

When [nonatomic
updates](Netfilter_-_ACLs.html#src-5868887_Netfilter-ACLs-nonatomic) are
