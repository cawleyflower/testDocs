...
weight: 179
aliases:
 - /display/CL332/Open+Shortest+Path+First+v3+-+OSPFv3+-+Protocol
...
[Quagga](/version/cumulus-linux-332/Layer_Three/Quagga_Overview) does
not support it yet.
...
See [Debugging
OSPF](Open_Shortest_Path_First_-_OSPF_-_Protocol.html#src-5869216_OpenShortestPathFirst-OSPF-Protocol-ospf_debug)
