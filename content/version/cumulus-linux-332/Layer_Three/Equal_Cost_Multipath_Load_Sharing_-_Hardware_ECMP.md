...
weight: 185
aliases:
 - /display/CL332/Equal+Cost+Multipath+Load+Sharing+-+Hardware+ECMP
 - /pages/viewpage.action?pageId=5869223
pageID: 5869223
...
section](Border_Gateway_Protocol_-_BGP.html#src-5869220_BorderGatewayProtocol-BGP-ecmp)
...
<span id="src-5869223_EqualCostMultipathLoadSharing-HardwareECMP-hashfields"></span>fields:
...
<span id="src-5869223_EqualCostMultipathLoadSharing-HardwareECMP-resilient_hashing"></span>
...
3.  [Restart](Configuring_switchd.html#src-5868885_Configuringswitchd-restartswitchd)
    the `switchd` service:
