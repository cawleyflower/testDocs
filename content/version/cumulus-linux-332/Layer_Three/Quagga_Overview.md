...
the following:
  ...
  - Open Shortest Path First
    ([v2](/version/cumulus-linux-332/Layer_Three/Open_Shortest_Path_First_-_OSPF_-_Protocol)
    and
    [v3](/version/cumulus-linux-332/Layer_Three/Open_Shortest_Path_First_v3_-_OSPFv3_-_Protocol))

  - [Border Gateway
    Protocol](/version/cumulus-linux-332/Layer_Three/Border_Gateway_Protocol_-_BGP)
