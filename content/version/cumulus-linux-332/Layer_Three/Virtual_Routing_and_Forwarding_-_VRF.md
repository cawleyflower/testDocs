...
weight: 189
aliases:
 - /display/CL332/Virtual+Routing+and+Forwarding+-+VRF
...
### <span id="src-5869236_VirtualRoutingandForwarding-VRF-vrf_cmd" class="confluence-anchor-link"></span><span>Using the vrf Command</span>
...
#### <span id="src-5869236_VirtualRoutingandForwarding-VRF-exec" class="confluence-anchor-link"></span><span>Running IPv4 and IPv6 Commands in a VRF Context </span>
...
[Quagga](/version/cumulus-linux-332/Layer_Three/Quagga_Overview) learns
...
configurations](/version/cumulus-linux-332/Layer_Three/Border_Gateway_Protocol_-_BGP)
...
<p>{{%notice tip%}}</p>
<p>You can create this configuration using the <code>vrf</code> command (<a href="#src-5869236_VirtualRoutingandForwarding-VRF-exec">see above</a> for more details):</p>
...
<p>{{%notice tip%}}</p>
<p>You can create this configuration using the <code>vrf</code> command (<a href="#src-5869236_VirtualRoutingandForwarding-VRF-exe">see above</a> for more details):</p>
...
<p>{{%notice tip%}}</p>
<p>You can create this configuration using the <code>vrf</code> command (<a href="#src-5869236_VirtualRoutingandForwarding-VRF-ex">see above</a> for more details):</p>
