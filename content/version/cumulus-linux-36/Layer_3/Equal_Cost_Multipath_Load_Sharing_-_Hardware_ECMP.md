...
section](Border_Gateway_Protocol_-_BGP.html#src-8362396_BorderGatewayProtocol-BGP-ecmp)
...
### <span>Configuring a Hash Seed to Avoid Hash Polarization</span>
...
3.  [Restart](Configuring_switchd.html#src-8362056_Configuringswitchd-restartswitchd)
    the `switchd` service:
