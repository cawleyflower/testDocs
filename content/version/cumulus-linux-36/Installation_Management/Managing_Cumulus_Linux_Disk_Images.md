...
## <span id="src-8362129_ManagingCumulusLinuxDiskImages-new_image" class="confluence-anchor-link"></span><span>Installing a New Cumulus Linux Image</span>
...
## <span id="src-8362129_ManagingCumulusLinuxDiskImages-upgrade" class="confluence-anchor-link"></span><span>Upgrading Cumulus Linux</span>
...
Linux](/version/cumulus-linux-36/Installation_Management/Upgrading_Cumulus_Linux).
...
You can cancel a pending rescue boot operation by using `onie-select
-c`:
