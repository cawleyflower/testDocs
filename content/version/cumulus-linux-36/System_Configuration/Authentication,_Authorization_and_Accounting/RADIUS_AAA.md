...
4.  Set the `vrf-name` field. This is typically set to *mgmt* if you are
    using a [management
    VRF](/version/cumulus-linux-36/Layer_3/Management_VRF). You cannot
...
## <span>Related Information</span>
  ...
  - [TACACS+
    client](/version/cumulus-linux-36/System_Configuration/Authentication_Authorization_and_Accounting/TACACS_Plus)
