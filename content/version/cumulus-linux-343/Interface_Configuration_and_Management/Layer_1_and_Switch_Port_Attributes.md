...
weight: 91
aliases:
 - /display/CL34/Layer+1+and+Switch+Port+Attributes
 - /pages/viewpage.action?pageId=7112615
pageID: 7112615
...
[table below](#src-7112615_Layer1andSwitchPortAttributes-settings).

Ports are always automatically configured on a Mellanox-based switch,
with one exception — you only need to configure is
[MTU](#src-7112615_Layer1andSwitchPortAttributes-mtu). You don't even
need to enable auto-negotation, as the Mellanox firmware configures
everything for you.

### <span id="src-7112615_Layer1andSwitchPortAttributes-autoneg_enable" class="confluence-anchor-link"></span><span>Enabling Auto-negotiation</span>
...
below](#src-7112615_Layer1andSwitchPortAttributes-sett).
...
(see the [table
below](#src-7112615_Layer1andSwitchPortAttributes-setting)). FEC always
adjusts for the speed of the cable. However, you **cannot** disable FEC
separately using
[NCLU](/version/cumulus-linux-343/System_Configuration/Network_Command_Line_Utility_-_NCLU).

### <span id="src-7112615_Layer1andSwitchPortAttributes-settings" class="confluence-anchor-link"></span><span>Default Interface Configuration Settings</span>
...
<tbody>
<tr class="odd">
<td><p>10/100 Base-T (RJ45 SFP)</p></td>
<td><p>Off</p></td>
...
<tr class="even">
<td><p>10/100 Base-T on a 1G fixed copper port</p></td>
...
iface swp1
  ...
  link-speed 100</code></pre></td>
<td><ul>
<li><p>10M or 100M speeds are possible with autoneg OFF on both sides. Testing on an Edge-Core AS4610-54P revealed the ASIC reporting autoneg as ON.</p></li>
<li><p>PoE may require autoneg to be ON.</p></li>
</ul></td>
</tr>
<tr class="odd">
<td><p>1000BASE-T<br />
...
<tr class="even">
<td><p>1G BASE-T on a 1G fixed copper port</p></td>
<td><p>On</p></td>
<td><p>N/A</p></td>
<td><pre><code>$ net add interface swp1 link speed 1000
$ net add interface swp1 link autoneg on</code></pre>
...
<tr class="odd">
<td><p>1G BASE-T on a 10G fixed copper port</p></td>
<td><p>On</p></td>
<td><p>N/A</p></td>
<td><pre><code>$ net add interface swp1 link speed 1000
$ net add interface swp1 link autoneg on</code></pre>
...
<tr class="odd">
<td><p>10G BASE-T fixed copper port</p></td>
<td><p>On</p></td>
<td><p>N/A</p></td>
...
below](#src-7112615_Layer1andSwitchPortAttributes-breakout).

### <span id="src-7112615_Layer1andSwitchPortAttributes-mtu" class="confluence-anchor-link"></span><span>MTU</span>
...
<span id="src-7112615_Layer1andSwitchPortAttributes-mtu_vxlan"></span>If
you are working with
[VXLANs](/version/cumulus-linux-343/Network_Virtualization/), the MTU
...
### <span>Setting a Policy for Global System MTU</span>
...
Not all platforms have the ability to set the a High MTU value on the
Eth0 management interface. To show a logical default, we've done the
above.
...
### <span>Creating a Default Policy for Various Interface Settings</span>
...
## <span id="src-7112615_Layer1andSwitchPortAttributes-breakout" class="confluence-anchor-link"></span><span>Configuring Breakout Ports</span>
...
services](Configuring_switchd.html#src-7112319_Configuringswitchd-restartswitchd).
...
See [the note](#src-7112615_Layer1andSwitchPortAttributes-breakout)
above.

## <span id="src-7112615_Layer1andSwitchPortAttributes-ethtool" class="confluence-anchor-link"></span><span>Using ethtool to Configure Interfaces</span>
