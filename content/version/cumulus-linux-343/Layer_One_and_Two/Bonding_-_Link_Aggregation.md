...
[LACP Bypass](/version/cumulus-linux-343/Layer_One_and_Two/LACP_Bypass).
...
<td><p>Enables <a href="/version/cumulus-linux-343/Layer_One_and_Two/LACP_Bypass">LACP bypass</a>.</p></td>
<td><p>N/A</p></td>
</tr>
<tr class="odd">
<td><p><code>bond lacp-rate</code></p></td>
<td><p>Sets the rate to ask the link partner to transmit LACP control packets.</p>
<p>You can set the LACP rate to slow using <a href="/version/cumulus-linux-343/System_Configuration/Network_Command_Line_Utility_-_NCLU">NCLU</a>:</p>
...
### <span id="src-7112409_Bonding-LinkAggregation-balance_xor" class="confluence-anchor-link"></span><span>Enabling balance-xor Mode</span>
