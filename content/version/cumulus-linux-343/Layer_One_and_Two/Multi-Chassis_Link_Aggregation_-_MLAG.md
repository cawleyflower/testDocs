...
## <span id="src-7112429_Multi-ChassisLinkAggregation-MLAG-reqs" class="confluence-anchor-link"></span><span>MLAG Requirements</span>
...
MLAG has these requirements:
  ...
  - The dual-connected devices (servers or switches) can use LACP (IEEE
    ...
    [bond](/version/cumulus-linux-343/Layer_One_and_Two/Bonding_-_Link_Aggregation).
    ...
    [balance-xor
    mode](Bonding_-_Link_Aggregation.html#src-7112409_Bonding-LinkAggregation-balance_xor)
...
## <span id="src-7112429_Multi-ChassisLinkAggregation-MLAG-configuring" class="confluence-anchor-link"></span><span>Configuring MLAG</span>
...
configuration changes, including:
  ...
  - Port configuration: For example, VLAN membership,
    [MTU](#src-7112429_Multi-ChassisLinkAggregation-MLAG-mtu) and
    bonding parameters.
...
[below](#src-7112429_Multi-ChassisLinkAggregation-MLAG-example).
...
peer switches, you should do the following:
  ...
  - Optionally, you can specify a backup interface, which is any layer 3
    ...
    goes down. [See
    below](#src-7112429_Multi-ChassisLinkAggregation-MLAG-backup) for
...
unnumbered](/version/cumulus-linux-343/Layer_Three/Border_Gateway_Protocol_-_BGP)
interfaces.

{{%/notice%}}

### <span id="src-7112429_Multi-ChassisLinkAggregation-MLAG-roles" class="confluence-anchor-link"></span><span>Understanding Switch Roles and Setting Priority</span>
...
## <span id="src-7112429_Multi-ChassisLinkAggregation-MLAG-example" class="confluence-anchor-link"></span><span>Example MLAG Configuration</span>
...
use](VLAN-aware_Bridge_Mode_for_Large-scale_Layer_2_Environments.html#src-7112421_VLAN-awareBridgeModeforLarge-scaleLayer2Environments-range).
...
[untagged/native](/version/cumulus-linux-343/Layer_One_and_Two/Ethernet_Bridging_-_VLANs/Traditional_Mode_Bridges)
...
## <span id="src-7112429_Multi-ChassisLinkAggregation-MLAG-protodown" class="confluence-anchor-link"></span><span>Peer Link Interfaces and the protodown State</span>
...
### <span id="src-7112429_Multi-ChassisLinkAggregation-MLAG-backup" class="confluence-anchor-link"></span><span>Specifying a Backup Link</span>
...
#### <span id="src-7112429_Multi-ChassisLinkAggregation-MLAG-vrf_backup" class="confluence-anchor-link"></span><span>Specifying a Backup Link to a VRF</span>

You can configure the backup link to a
[VRF](/version/cumulus-linux-343/Layer_Three/Virtual_Routing_and_Forwarding_-_VRF)
or [management
VRF](/version/cumulus-linux-343/Layer_Three/Management_VRF). Include the
...
[IGMP
snooping](/version/cumulus-linux-343/Layer_One_and_Two/IGMP_and_MLD_Snooping)
...
MLAG](#src-7112429_Multi-ChassisLinkAggregation-MLAG-configuring)
section.

### <span id="src-7112429_Multi-ChassisLinkAggregation-MLAG-mtu" class="confluence-anchor-link"></span><span>Understanding MTU in an MLAG Configuration</span>

Note that the
[MTU](/version/cumulus-linux-343/Interface_Configuration_and_Management/Layer_1_and_Switch_Port_Attributes)
...
`mtu 9216`](/version/cumulus-linux-343/Interface_Configuration_and_Management/Layer_1_and_Switch_Port_Attributes)
...
Assurance](Spanning_Tree_and_Rapid_Spanning_Tree.html#src-7112441_SpanningTreeandRapidSpanningTree-bpdu).)
...
### <span id="src-7112429_Multi-ChassisLinkAggregation-MLAG-drops" class="confluence-anchor-link"></span><span>Large Packet Drops on the Peerlink Interface</span>
