...
## <span>What's New and Different in NCLU in Version 3.4?</span>

A number of commands have been added, updated, or removed from NCLU in
the new release. Read more about [what's
changed](https://support.cumulusnetworks.com/hc/en-us/articles/115011823667-NCLU-What-s-New-and-Different-in-Cumulus-Linux-3-4-0).
...
using:
  ...
  - `net commit permanent`: Retains the
    [snapshot](/version/cumulus-linux-343/Installation_Management/Using_Snapshots)
...
### <span id="src-7112338_NetworkCommandLineUtility-NCLU-questionmark" class="confluence-anchor-link"></span><span>Adding ? (Question Mark) Ability to NCLU</span>
...
group](TACACS_Plus.html#src-7112316_TACACSPlus-nclu).

{{%/notice%}}

## <span id="src-7112338_NetworkCommandLineUtility-NCLU-restart" class="confluence-anchor-link"></span><span>Restarting the netd Service</span>
...
## <span id="src-7112338_NetworkCommandLineUtility-NCLU-backuptofile" class="confluence-anchor-link"></span><span>Backing up the Configuration to a Single File</span>
...
## <span id="src-7112338_NetworkCommandLineUtility-NCLU-conf" class="confluence-anchor-link"></span><span>Advanced Configuration</span>
