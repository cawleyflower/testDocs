...
below](#src-7112365_SNMPMonitoring-passpersist) for more information on
...
### <span id="src-7112365_SNMPMonitoring-agentAddress" class="confluence-anchor-link"></span><span>Configuring the agentAddress</span>
...
### <span id="src-7112365_SNMPMonitoring-public_community" class="confluence-anchor-link"></span><span>Setting the Community String</span>
...
<tr class="odd">
<td><p><strong><a href="/version/cumulus-linux-343/Monitoring_and_Troubleshooting/SNMP_Monitoring/Using_Nutanix_Prism_as_a_Monitoring_Tool">Nutanix Prism CLI</a></strong> (SSH to the cluster IP address)</p></td>
...
<span id="src-7112365_SNMPMonitoring-bgp4"></span></td>
<td><p>FRRouting SNMP support may be enabled to provide support for OSPF-MIB (RFC-1850), OSPFV3-MIB (RFC-5643), and BGP4-MIB (RFC-4273). To enable this support, see the <a href="#src-7112365_SNMPMonitoring-frr">FRRouting section</a> above.</p></td>
</tr>
<tr class="odd">
...
<td><p>L2 neighbor info from <code>lldpd</code> (note, you need to <a href="Link_Layer_Discovery_Protocol.html#src-7112404_LinkLayerDiscoveryProtocol-snmp">enable the SNMP subagent</a> in LLDP). <code>lldpd</code> needs to be started with the <code>-x</code> option to enable connectivity to <code>snmpd</code> (AgentX).</p></td>
</tr>
<tr class="even">
...
## <span id="src-7112365_SNMPMonitoring-passpersist" class="confluence-anchor-link"></span><span>About Pass Persist Scripts</span>
...
`bgp4_pp.py` and `cl_poe_pp.py` scripts:
  ...
  - `cl_poe_pp.py` is disabled by default as only some platforms that
    ...
    Ethernet](/version/cumulus-linux-343/System_Configuration/Power_over_Ethernet_-_PoE).
