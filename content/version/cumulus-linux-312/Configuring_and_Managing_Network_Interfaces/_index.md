...
weight: 19
aliases:
 - /display/CL31/Configuring+and+Managing+Network+Interfaces
 - /pages/viewpage.action?pageId=5122104
pageID: 5122104
...
Attributes](/version/cumulus-linux-312/Configuring_and_Managing_Network_Interfaces/Layer_1_and_Switch_Port_Attributes).
...
## <span id="src-5122104_ConfiguringandManagingNetworkInterfaces-classes" class="confluence-anchor-link"></span><span>ifupdown2 Interface Classes</span>
...
[Management
VRF](/version/cumulus-linux-312/Layer_3_Features/Management_VRF), you
...
<span id="src-5122104_ConfiguringandManagingNetworkInterfaces-ip"></span>ifupdown
...
link speed, and so
forth](/version/cumulus-linux-312/Configuring_and_Managing_Network_Interfaces/Layer_1_and_Switch_Port_Attributes).
...
To work around this issue, configure the IP address scope using `post-up
ip address add <address> dev <interface> scope <scope>`. In continuing
...
Now, when you run `ifreload -a` on this configuration, it has the
correct scope:
...
Errata](#src-5122104_ConfiguringandManagingNetworkInterfaces-caveats)
...
For example, say you want to restart the `dhcrelay` service after
bringing up a VLAN. Your configuration in `/etc/network/interfaces`
...
OID](Monitoring_System_Hardware.html#src-5121949_MonitoringSystemHardware-snmp)
...
## <span id="src-5122104_ConfiguringandManagingNetworkInterfaces-caveats" class="confluence-anchor-link"></span><span>Caveats and Errata</span>
