...
weight: 45
aliases:
 - /display/CL31/Zero+Touch+Provisioning+-+ZTP
 - /pages/viewpage.action?pageId=5121983
pageID: 5121983
...
rack and stack the switch, connect it to the management network, then
install Cumulus Linux via ONIE; the initial configuration gets invoked
via ZTP. Alternatively, you can insert a USB stick with the
configuration so the provisioning process can start automatically.
...
3.  The script's contents are parsed to ensure it contains the
    ...
    scripts](#src-5121983_ZeroTouchProvisioning-ZTP-example_scripts)).
...
4.  The zero touch provisioning process requests the contents of the
    ...
    headers](#src-5121983_ZeroTouchProvisioning-ZTP-http_headers)
...
### <span id="src-5121983_ZeroTouchProvisioning-ZTP-http_headers" class="confluence-anchor-link"></span><span>Detailed Look at HTTP Headers</span>
...
### <span id="src-5121983_ZeroTouchProvisioning-ZTP-example_scripts" class="confluence-anchor-link"></span><span>Example ZTP Scripts</span>
