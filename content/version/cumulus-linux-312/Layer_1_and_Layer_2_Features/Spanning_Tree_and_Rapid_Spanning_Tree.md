...
be found
here.](/version/cumulus-linux-312/Layer_1_and_Layer_2_Features/Ethernet_Bridging_-_VLANs/)
...
### <span id="src-5122089_SpanningTreeandRapidSpanningTree-bpdu" class="confluence-anchor-link"></span><span> BPDU Guard</span>
...
You configure storm control for each physical port in one of three ways:
  ...
  - By writing directly to the [`switchd` file
    system](/version/cumulus-linux-312/System_Management/Configuring_switchd).
...
### <span id="src-5122089_SpanningTreeandRapidSpanningTree-params" class="confluence-anchor-link"></span><span>Configuring Other Spanning Tree Parameters</span>
