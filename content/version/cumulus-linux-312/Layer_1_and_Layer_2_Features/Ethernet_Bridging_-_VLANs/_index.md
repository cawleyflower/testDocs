...
Cumulus Linux has a unique method for configuring bridges that are
...
<p>For more information on spanning-tree configurations see the configuration section: <a href="/version/cumulus-linux-312/Layer_1_and_Layer_2_Features/Spanning_Tree_and_Rapid_Spanning_Tree">Spanning Tree and Rapid Spanning Tree</a>.</p></td>
</tr>
</tbody>
</table>
...
## <span id="src-5122007_EthernetBridging-VLANs-VLAN_tagging" class="confluence-anchor-link"></span><span>Using Trunks in Traditional Bridging Mode</span>
...
chapter](/version/cumulus-linux-312/Layer_1_and_Layer_2_Features/Ethernet_Bridging_-_VLANs/VLAN_Tagging).
...
## <span>Caveats and Errata</span>
  ...
  - In environments where both VLAN-aware and traditional bridges are in
    use, where a traditional bridge has a subinterface of a bond that is
