...
weight: 101
aliases:
 - /display/CL31/Link+Layer+Discovery+Protocol
 - /pages/viewpage.action?pageId=5122001
pageID: 5122001
...
`lldpd` logs to `/var/log/daemon.log` with the *lldpd* prefix:
    ...
    2016-11-23T14:48:37.538595-05:00 switch lldpd[21945]: protocol LLDP enabled
    2016-11-23T14:48:37.539266-05:00 switch lldpd[21945]: protocol CDPv1 enabled
    2016-11-23T14:48:37.539937-05:00 switch lldpd[21945]: protocol CDPv2 enabled
    2016-11-23T14:48:37.540604-05:00 switch lldpd[21945]: libevent 2.0.21-stable initialized with epoll method
    2016-11-23T14:48:37.541270-05:00 switch lldpd[21945]: enable SNMP subagent
    2016-11-23T14:48:37.542295-05:00 switch lldpd[21945]: NET-SNMP version 5.7.3 AgentX subagent connected
    2016-11-23T14:48:37.633597-05:00 switch lldpcli[21943]: LLDP PortID TLV type set to new value : ifname
    2016-11-23T14:48:37.634389-05:00 switch lldpcli[21943]: lldpd should resume operations
...
## <span id="src-5122001_LinkLayerDiscoveryProtocol-snmp" class="confluence-anchor-link"></span><span>Enabling the SNMP Subagent in LLDP</span>

LLDP does not enable the SNMP subagent by default. Configure the
`DAEMON_ARGS=` variable in `/etc/default/lldpd` by adding the `-x`
option to enable the SNMP subagent.

    cumulus@switch:~$ sudo nano /etc/default/lldpd 
    # Enable CDP by default
    DAEMON_ARGS="$DAEMON_OPT_ARGS -c -x"
