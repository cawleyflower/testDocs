...
section](Border_Gateway_Protocol_-_BGP.html#src-5122130_BorderGatewayProtocol-BGP-ecmp)
...
3.  [Restart](Configuring_switchd.html#src-5121932_Configuringswitchd-restartswitchd)
    the `switchd` service:
